...
<template>
  ...
  <div id="Vue3" class="content">
    <div class="box">
      ...
      1.dotnet7_vue3<span class="pdf">download></span></a></div>
      <div><a href="https://www.youtube.com/watch?v=2FoD_8dMGyU&list=PLFbd8KZNbe---KNiUInMOOSEtmfudpONG" target="_blank">
      2.【黑馬程序員】前端Vue3小兔鮮實戰項目<span class="pdf">YouTube</span></a></div>
      <div><a
      ...
      2.ASP.NET Core Web API 入門教學<span class="pdf">YouTube</span></a></div>
      <div><a
