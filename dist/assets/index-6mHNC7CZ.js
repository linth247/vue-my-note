 ...
 */const tc=Symbol();var Ns;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(Ns||(Ns={}));function oc(){const e=Vi(!0),t=e.run(()=>xe({}));let o=[],n=[];const s=Ir({install(r){s._a=r,r.provide(tc,s),r.config.globalProperties.$pinia=s,n.forEach(i=>o.push(i)),n=[]},use(r){return!this._a&&!ec?n.push(r):o.push(r),this},_p:o,_a:null,_e:e,_s:new Map,state:t});return s}/*!
  ...
  */const Ot=typeof document<"u";function nc(e){return e.__esModule||e[Symbol.toStringTag]==="Module"}const re=Object.assign;function ln(e,t){const o={};for(const n in t){const s=t[n];o[n]=qe(s)?s.map(e):e(s)}return o}const oo=()=>{},qe=Array.isArray,pi=/#/g,sc=/&/g,rc=/\//g,ic=/=/g,ac=/\?/g,hi=/\+/g,lc=/%5B/g,cc=/%5D/g,mi=/%5E/g,uc=/%60/g,gi=/%7B/g,dc=/%7C/g,bi=/%7D/g,fc=/%20/g;function jn(e){return encodeURI(""+e).replace(dc,"|").replace(lc,"[").replace(cc,"]")}function pc(e){return jn(e).replace(gi,"{").replace(bi,"}").replace(mi,"^")}function In(e){return jn(e).replace(hi,"%2B").replace(fc,"+").replace(pi,"%23").replace(sc,"%26").replace(uc,"`").replace(gi,"{").replace(bi,"}").replace(mi,"^")}function hc(e){return In(e).replace(ic,"%3D")}function mc(e){return jn(e).replace(pi,"%23").replace(ac,"%3F")}function gc(e){return e==null?"":mc(e).replace(rc,"%2F")}function uo(e){try{return decodeURIComponent(""+e)}catch{}return""+e}const bc=/\/$/,vc=e=>e.replace(bc,"");function cn(e,t,o="/"){let n,s={},r="",i="";const l=t.indexOf("#");let a=t.indexOf("?");return l<a&&l>=0&&(a=-1),a>-1&&(n=t.slice(0,a),r=t.slice(a+1,l>-1?l:t.length),s=e(r)),l>-1&&(n=n||t.slice(0,l),i=t.slice(l,t.length)),n=Ac(n??t,o),{fullPath:n+(r&&"?")+r+i,path:n,query:s,hash:uo(i)}}function yc(e,t){const o=t.query?e(t.query):"";return t.path+(o&&"?")+o+(t.hash||"")}function Us(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function _c(e,t,o){const n=t.matched.length-1,s=o.matched.length-1;return n>-1&&n===s&&$t(t.matched[n],o.matched[s])&&vi(t.params,o.params)&&e(t.query)===e(o.query)&&t.hash===o.hash}function $t(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function vi(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(const o in e)if(!wc(e[o],t[o]))return!1;return!0}function wc(e,t){return qe(e)?Ws(e,t):qe(t)?Ws(t,e):e===t}function Ws(e,t){return qe(t)?e.length===t.length&&e.every((o,n)=>o===t[n]):e.length===1&&e[0]===t}function Ac(e,t){if(e.startsWith("/"))return e;if(!e)return t;const o=t.split("/"),n=e.split("/"),s=n[n.length-1];(s===".."||s===".")&&n.push("");let r=o.length-1,i,l;for(i=0;i<n.length;i++)if(l=n[i],l!==".")if(l==="..")r>1&&r--;else break;return o.slice(0,r).join("/")+"/"+n.slice(i).join("/")}const ft={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var fo;(function(e){e.pop="pop",e.push="push"})(fo||(fo={}));var no;(function(e){e.back="back",e.forward="forward",e.unknown=""})(no||(no={}));function Ic(e){if(!e)if(Ot){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),vc(e)}const Cc=/^[^#]+#/;function Tc(e,t){return e.replace(Cc,"#")+t}function Sc(e,t){const o=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-o.left-(t.left||0),top:n.top-o.top-(t.top||0)}}const Jo=()=>({left:window.scrollX,top:window.scrollY});function Pc(e){let t;if("el"in e){const o=e.el,n=typeof o=="string"&&o.startsWith("#"),s=typeof o=="string"?n?document.getElementById(o.slice(1)):document.querySelector(o):o;if(!s)return;t=Sc(s,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function Ms(e,t){return(history.state?history.state.position-t:-1)+e}const Cn=new Map;function xc(e,t){Cn.set(e,t)}function Ec(e){const t=Cn.get(e);return Cn.delete(e),t}let Dc=()=>location.protocol+"//"+location.host;function yi(e,t){const{pathname:o,search:n,hash:s}=t,r=e.indexOf("#");if(r>-1){let l=s.includes(e.slice(r))?e.slice(r).length:1,a=s.slice(l);return a[0]!=="/"&&(a="/"+a),Us(a,"")}return Us(o,e)+n+s}function Lc(e,t,o,n){let s=[],r=[],i=null;const l=({state:h})=>{const g=yi(e,location),L=o.value,x=t.value;let V=0;if(h){if(o.value=g,t.value=h,i&&i===L){i=null;return}V=x?h.position-x.position:0}else n(g);s.forEach(H=>{H(o.value,L,{delta:V,type:fo.pop,direction:V?V>0?no.forward:no.back:no.unknown})})};function a(){i=o.value}function f(h){s.push(h);const g=()=>{const L=s.indexOf(h);L>-1&&s.splice(L,1)};return r.push(g),g}function d(){const{history:h}=window;h.state&&h.replaceState(re({},h.state,{scroll:Jo()}),"")}function p(){for(const h of r)h();r=[],window.removeEventListener("popstate",l),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",l),window.addEventListener("beforeunload",d,{passive:!0}),{pauseListeners:a,listen:f,destroy:p}}function Hs(e,t,o,n=!1,s=!1){return{back:e,current:t,forward:o,replaced:n,position:window.history.length,scroll:s?Jo():null}}function kc(e){const{history:t,location:o}=window,n={value:yi(e,o)},s={value:t.state};s.value||r(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function r(a,f,d){const p=e.indexOf("#"),h=p>-1?(o.host&&document.querySelector("base")?e:e.slice(p))+a:Dc()+e+a;try{t[d?"replaceState":"pushState"](f,"",h),s.value=f}catch(g){console.error(g),o[d?"replace":"assign"](h)}}function i(a,f){const d=re({},t.state,Hs(s.value.back,a,s.value.forward,!0),f,{position:s.value.position});r(a,d,!0),n.value=a}function l(a,f){const d=re({},s.value,t.state,{forward:a,scroll:Jo()});r(d.current,d,!0);const p=re({},Hs(n.value,a,null),{position:d.position+1},f);r(a,p,!1),n.value=a}return{location:n,state:s,push:l,replace:i}}function Rc(e){e=Ic(e);const t=kc(e),o=Lc(e,t.state,t.location,t.replace);function n(r,i=!0){i||o.pauseListeners(),history.go(r)}const s=re({location:"",base:e,go:n,createHref:Tc.bind(null,e)},t,o);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>t.state.value}),s}function Nc(e){return typeof e=="string"||e&&typeof e=="object"}function _i(e){return typeof e=="string"||typeof e=="symbol"}const wi=Symbol("");var Os;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(Os||(Os={}));function Kt(e,t){return re(new Error,{type:e,[wi]:!0},t)}function ot(e,t){return e instanceof Error&&wi in e&&(t==null||!!(e.type&t))}const Fs="[^/]+?",Uc={sensitive:!1,strict:!1,start:!0,end:!0},Wc=/[.+*?^${}()[\]/\\]/g;function Mc(e,t){const o=re({},Uc,t),n=[];let s=o.start?"^":"";const r=[];for(const f of e){const d=f.length?[]:[90];o.strict&&!f.length&&(s+="/");for(let p=0;p<f.length;p++){const h=f[p];let g=40+(o.sensitive?.25:0);if(h.type===0)p||(s+="/"),s+=h.value.replace(Wc,"\\$&"),g+=40;else if(h.type===1){const{value:L,repeatable:x,optional:V,regexp:H}=h;r.push({name:L,repeatable:x,optional:V});const U=H||Fs;if(U!==Fs){g+=10;try{new RegExp(`(${U})`)}catch(q){throw new Error(`Invalid custom RegExp for param "${L}" (${U}): `+q.message)}}let k=x?`((?:${U})(?:/(?:${U}))*)`:`(${U})`;p||(k=V&&f.length<2?`(?:/${k})`:"/"+k),V&&(k+="?"),s+=k,g+=20,V&&(g+=-8),x&&(g+=-20),U===".*"&&(g+=-50)}d.push(g)}n.push(d)}if(o.strict&&o.end){const f=n.length-1;n[f][n[f].length-1]+=.7000000000000001}o.strict||(s+="/?"),o.end?s+="$":o.strict&&(s+="(?:/|$)");const i=new RegExp(s,o.sensitive?"":"i");function l(f){const d=f.match(i),p={};if(!d)return null;for(let h=1;h<d.length;h++){const g=d[h]||"",L=r[h-1];p[L.name]=g&&L.repeatable?g.split("/"):g}return p}function a(f){let d="",p=!1;for(const h of e){(!p||!d.endsWith("/"))&&(d+="/"),p=!1;for(const g of h)if(g.type===0)d+=g.value;else if(g.type===1){const{value:L,repeatable:x,optional:V}=g,H=L in f?f[L]:"";if(qe(H)&&!x)throw new Error(`Provided param "${L}" is an array but it is not repeatable (* or + modifiers)`);const U=qe(H)?H.join("/"):H;if(!U)if(V)h.length<2&&(d.endsWith("/")?d=d.slice(0,-1):p=!0);else throw new Error(`Missing required param "${L}"`);d+=U}}return d||"/"}return{re:i,score:n,keys:r,parse:l,stringify:a}}function Hc(e,t){let o=0;for(;o<e.length&&o<t.length;){const n=t[o]-e[o];if(n)return n;o++}return e.length<t.length?e.length===1&&e[0]===80?-1:1:e.length>t.length?t.length===1&&t[0]===80?1:-1:0}function Ai(e,t){let o=0;const n=e.score,s=t.score;for(;o<n.length&&o<s.length;){const r=Hc(n[o],s[o]);if(r)return r;o++}if(Math.abs(s.length-n.length)===1){if(Vs(n))return 1;if(Vs(s))return-1}return s.length-n.length}function Vs(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const Oc={type:0,value:""},Fc=/[a-zA-Z0-9_]/;function Vc(e){if(!e)return[[]];if(e==="/")return[[Oc]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(g){throw new Error(`ERR (${o})/"${f}": ${g}`)}let o=0,n=o;const s=[];let r;function i(){r&&s.push(r),r=[]}let l=0,a,f="",d="";function p(){f&&(o===0?r.push({type:0,value:f}):o===1||o===2||o===3?(r.length>1&&(a==="*"||a==="+")&&t(`A repeatable param (${f}) must be alone in its segment. eg: '/:ids+.`),r.push({type:1,value:f,regexp:d,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):t("Invalid state to consume buffer"),f="")}function h(){f+=a}for(;l<e.length;){if(a=e[l++],a==="\\"&&o!==2){n=o,o=4;continue}switch(o){case 0:a==="/"?(f&&p(),i()):a===":"?(p(),o=1):h();break;case 4:h(),o=n;break;case 1:a==="("?o=2:Fc.test(a)?h():(p(),o=0,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case 2:a===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+a:o=3:d+=a;break;case 3:p(),o=0,a!=="*"&&a!=="?"&&a!=="+"&&l--,d="";break;default:t("Unknown state");break}}return o===2&&t(`Unfinished custom RegExp for param "${f}"`),p(),i(),s}function Bc(e,t,o){const n=Mc(Vc(e.path),o),s=re(n,{record:e,parent:t,children:[],alias:[]});return t&&!s.record.aliasOf==!t.record.aliasOf&&t.children.push(s),s}function Gc(e,t){const o=[],n=new Map;t=js({strict:!1,end:!0,sensitive:!1},t);function s(p){return n.get(p)}function r(p,h,g){const L=!g,x=jc(p);x.aliasOf=g&&g.record;const V=js(t,p),H=[x];if("alias"in p){const q=typeof p.alias=="string"?[p.alias]:p.alias;for(const le of q)H.push(re({},x,{components:g?g.record.components:x.components,path:le,aliasOf:g?g.record:x}))}let U,k;for(const q of H){const{path:le}=q;if(h&&le[0]!=="/"){const O=h.record.path,ce=O[O.length-1]==="/"?"":"/";q.path=h.record.path+(le&&ce+le)}if(U=Bc(q,h,V),g?g.alias.push(U):(k=k||U,k!==U&&k.alias.push(U),L&&p.name&&!Gs(U)&&i(p.name)),Ii(U)&&a(U),x.children){const O=x.children;for(let ce=0;ce<O.length;ce++)r(O[ce],U,g&&g.children[ce])}g=g||U}return k?()=>{i(k)}:oo}function i(p){if(_i(p)){const h=n.get(p);h&&(n.delete(p),o.splice(o.indexOf(h),1),h.children.forEach(i),h.alias.forEach(i))}else{const h=o.indexOf(p);h>-1&&(o.splice(h,1),p.record.name&&n.delete(p.record.name),p.children.forEach(i),p.alias.forEach(i))}}function l(){return o}function a(p){const h=zc(p,o);o.splice(h,0,p),p.record.name&&!Gs(p)&&n.set(p.record.name,p)}function f(p,h){let g,L={},x,V;if("name"in p&&p.name){if(g=n.get(p.name),!g)throw Kt(1,{location:p});V=g.record.name,L=re(Bs(h.params,g.keys.filter(k=>!k.optional).concat(g.parent?g.parent.keys.filter(k=>k.optional):[]).map(k=>k.name)),p.params&&Bs(p.params,g.keys.map(k=>k.name))),x=g.stringify(L)}else if(p.path!=null)x=p.path,g=o.find(k=>k.re.test(x)),g&&(L=g.parse(x),V=g.record.name);else{if(g=h.name?n.get(h.name):o.find(k=>k.re.test(h.path)),!g)throw Kt(1,{location:p,currentLocation:h});V=g.record.name,L=re({},h.params,p.params),x=g.stringify(L)}const H=[];let U=g;for(;U;)H.unshift(U.record),U=U.parent;return{name:V,path:x,params:L,matched:H,meta:Kc(H)}}e.forEach(p=>r(p));function d(){o.length=0,n.clear()}return{addRoute:r,resolve:f,removeRoute:i,clearRoutes:d,getRoutes:l,getRecordMatcher:s}}function Bs(e,t){const o={};for(const n of t)n in e&&(o[n]=e[n]);return o}function jc(e){return{path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:void 0,beforeEnter:e.beforeEnter,props:$c(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}}}function $c(e){const t={},o=e.props||!1;if("component"in e)t.default=o;else for(const n in e.components)t[n]=typeof o=="object"?o[n]:o;return t}function Gs(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Kc(e){return e.reduce((t,o)=>re(t,o.meta),{})}function js(e,t){const o={};for(const n in e)o[n]=n in t?t[n]:e[n];return o}function zc(e,t){let o=0,n=t.length;for(;o!==n;){const r=o+n>>1;Ai(e,t[r])<0?n=r:o=r+1}const s=qc(e);return s&&(n=t.lastIndexOf(s,n-1)),n}function qc(e){let t=e;for(;t=t.parent;)if(Ii(t)&&Ai(e,t)===0)return t}function Ii({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Jc(e){const t={};if(e===""||e==="?")return t;const n=(e[0]==="?"?e.slice(1):e).split("&");for(let s=0;s<n.length;++s){const r=n[s].replace(hi," "),i=r.indexOf("="),l=uo(i<0?r:r.slice(0,i)),a=i<0?null:uo(r.slice(i+1));if(l in t){let f=t[l];qe(f)||(f=t[l]=[f]),f.push(a)}else t[l]=a}return t}function $s(e){let t="";for(let o in e){const n=e[o];if(o=hc(o),n==null){n!==void 0&&(t+=(t.length?"&":"")+o);continue}(qe(n)?n.map(r=>r&&In(r)):[n&&In(n)]).forEach(r=>{r!==void 0&&(t+=(t.length?"&":"")+o,r!=null&&(t+="="+r))})}return t}function Qc(e){const t={};for(const o in e){const n=e[o];n!==void 0&&(t[o]=qe(n)?n.map(s=>s==null?null:""+s):n==null?n:""+n)}return t}const Zc=Symbol(""),Ks=Symbol(""),$n=Symbol(""),Ci=Symbol(""),Tn=Symbol("");function Jt(){let e=[];function t(n){return e.push(n),()=>{const s=e.indexOf(n);s>-1&&e.splice(s,1)}}function o(){e=[]}return{add:t,list:()=>e.slice(),reset:o}}function gt(e,t,o,n,s,r=i=>i()){const i=n&&(n.enterCallbacks[s]=n.enterCallbacks[s]||[]);return()=>new Promise((l,a)=>{const f=h=>{h===!1?a(Kt(4,{from:o,to:t})):h instanceof Error?a(h):Nc(h)?a(Kt(2,{from:t,to:h})):(i&&n.enterCallbacks[s]===i&&typeof h=="function"&&i.push(h),l())},d=r(()=>e.call(n&&n.instances[s],t,o,f));let p=Promise.resolve(d);e.length<3&&(p=p.then(f)),p.catch(h=>a(h))})}function un(e,t,o,n,s=r=>r()){const r=[];for(const i of e)for(const l in i.components){let a=i.components[l];if(!(t!=="beforeRouteEnter"&&!i.instances[l]))if(Yc(a)){const d=(a.__vccOpts||a)[t];d&&r.push(gt(d,o,n,i,l,s))}else{let f=a();r.push(()=>f.then(d=>{if(!d)return Promise.reject(new Error(`Couldn't resolve component "${l}" at "${i.path}"`));const p=nc(d)?d.default:d;i.components[l]=p;const g=(p.__vccOpts||p)[t];return g&&gt(g,o,n,i,l,s)()}))}}return r}function Yc(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function zs(e){const t=rt($n),o=rt(Ci),n=Ke(()=>{const a=fe(e.to);return t.resolve(a)}),s=Ke(()=>{const{matched:a}=n.value,{length:f}=a,d=a[f-1],p=o.matched;if(!d||!p.length)return-1;const h=p.findIndex($t.bind(null,d));if(h>-1)return h;const g=qs(a[f-2]);return f>1&&qs(d)===g&&p[p.length-1].path!==g?p.findIndex($t.bind(null,a[f-2])):h}),r=Ke(()=>s.value>-1&&ou(o.params,n.value.params)),i=Ke(()=>s.value>-1&&s.value===o.matched.length-1&&vi(o.params,n.value.params));function l(a={}){return tu(a)?t[fe(e.replace)?"replace":"push"](fe(e.to)).catch(oo):Promise.resolve()}return{route:n,href:Ke(()=>n.value.href),isActive:r,isExactActive:i,navigate:l}}const Xc=Mr({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:zs,setup(e,{slots:t}){const o=Oo(zs(e)),{options:n}=rt($n),s=Ke(()=>({[Js(e.activeClass,n.linkActiveClass,"router-link-active")]:o.isActive,[Js(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:o.isExactActive}));return()=>{const r=t.default&&t.default(o);return e.custom?r:Fe("a",{"aria-current":o.isExactActive?e.ariaCurrentValue:null,href:o.href,onClick:o.navigate,class:s.value},r)}}}),eu=Xc;function tu(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function ou(e,t){for(const o in t){const n=t[o],s=e[o];if(typeof n=="string"){if(n!==s)return!1}else if(!qe(s)||s.length!==n.length||n.some((r,i)=>r!==s[i]))return!1}return!0}function qs(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Js=(e,t,o)=>e??t??o,nu=Mr({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:o}){const n=rt(Tn),s=Ke(()=>e.route||n.value),r=rt(Ks,0),i=Ke(()=>{let f=fe(r);const{matched:d}=s.value;let p;for(;(p=d[f])&&!p.components;)f++;return f}),l=Ke(()=>s.value.matched[i.value]);Io(Ks,Ke(()=>i.value+1)),Io(Zc,l),Io(Tn,s);const a=xe();return Co(()=>[a.value,l.value,e.name],([f,d,p],[h,g,L])=>{d&&(d.instances[p]=f,g&&g!==d&&f&&f===h&&(d.leaveGuards.size||(d.leaveGuards=g.leaveGuards),d.updateGuards.size||(d.updateGuards=g.updateGuards))),f&&d&&(!g||!$t(d,g)||!h)&&(d.enterCallbacks[p]||[]).forEach(x=>x(f))},{flush:"post"}),()=>{const f=s.value,d=e.name,p=l.value,h=p&&p.components[d];if(!h)return Qs(o.default,{Component:h,route:f});const g=p.props[d],L=g?g===!0?f.params:typeof g=="function"?g(f):g:null,V=Fe(h,re({},L,t,{onVnodeUnmounted:H=>{H.component.isUnmounted&&(p.instances[d]=null)},ref:a}));return Qs(o.default,{Component:V,route:f})||V}}});function Qs(e,t){if(!e)return null;const o=e(t);return o.length===1?o[0]:o}const Ti=nu;function su(e){const t=Gc(e.routes,e),o=e.parseQuery||Jc,n=e.stringifyQuery||$s,s=e.history,r=Jt(),i=Jt(),l=Jt(),a=ua(ft);let f=ft;Ot&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=ln.bind(null,y=>""+y),p=ln.bind(null,gc),h=ln.bind(null,uo);function g(y,E){let S,N;return _i(y)?(S=t.getRecordMatcher(y),N=E):N=y,t.addRoute(N,S)}function L(y){const E=t.getRecordMatcher(y);E&&t.removeRoute(E)}function x(){return t.getRoutes().map(y=>y.record)}function V(y){return!!t.getRecordMatcher(y)}function H(y,E){if(E=re({},E||a.value),typeof y=="string"){const u=cn(o,y,E.path),m=t.resolve({path:u.path},E),_=s.createHref(u.fullPath);return re(u,m,{params:h(m.params),hash:uo(u.hash),redirectedFrom:void 0,href:_})}let S;if(y.path!=null)S=re({},y,{path:cn(o,y.path,E.path).path});else{const u=re({},y.params);for(const m in u)u[m]==null&&delete u[m];S=re({},y,{params:p(u)}),E.params=p(E.params)}const N=t.resolve(S,E),se=y.hash||"";N.params=d(h(N.params));const he=yc(n,re({},y,{hash:pc(se),path:N.path})),c=s.createHref(he);return re({fullPath:he,hash:se,query:n===$s?Qc(y.query):y.query||{}},N,{redirectedFrom:void 0,href:c})}function U(y){return typeof y=="string"?cn(o,y,a.value.path):re({},y)}function k(y,E){if(f!==y)return Kt(8,{from:E,to:y})}function q(y){return ce(y)}function le(y){return q(re(U(y),{replace:!0}))}function O(y){const E=y.matched[y.matched.length-1];if(E&&E.redirect){const{redirect:S}=E;let N=typeof S=="function"?S(y):S;return typeof N=="string"&&(N=N.includes("?")||N.includes("#")?N=U(N):{path:N},N.params={}),re({query:y.query,hash:y.hash,params:N.path!=null?{}:y.params},N)}}function ce(y,E){const S=f=H(y),N=a.value,se=y.state,he=y.force,c=y.replace===!0,u=O(S);if(u)return ce(re(U(u),{state:typeof u=="object"?re({},se,u.state):se,force:he,replace:c}),E||S);const m=S;m.redirectedFrom=E;let _;return!he&&_c(n,N,S)&&(_=Kt(16,{to:m,from:N}),Je(N,N,!0,!1)),(_?Promise.resolve(_):X(m,N)).catch(v=>ot(v)?ot(v,2)?v:lt(v):oe(v,m,N)).then(v=>{if(v){if(ot(v,2))return ce(re({replace:c},U(v.to),{state:typeof v.to=="object"?re({},se,v.to.state):se,force:he}),E||m)}else v=R(m,N,!0,c,se);return ue(m,N,v),v})}function ye(y,E){const S=k(y,E);return S?Promise.reject(S):Promise.resolve()}function j(y){const E=Mt.values().next().value;return E&&typeof E.runWithContext=="function"?E.runWithContext(y):y()}function X(y,E){let S;const[N,se,he]=ru(y,E);S=un(N.reverse(),"beforeRouteLeave",y,E);for(const u of N)u.leaveGuards.forEach(m=>{S.push(gt(m,y,E))});const c=ye.bind(null,y,E);return S.push(c),He(S).then(()=>{S=[];for(const u of r.list())S.push(gt(u,y,E));return S.push(c),He(S)}).then(()=>{S=un(se,"beforeRouteUpdate",y,E);for(const u of se)u.updateGuards.forEach(m=>{S.push(gt(m,y,E))});return S.push(c),He(S)}).then(()=>{S=[];for(const u of he)if(u.beforeEnter)if(qe(u.beforeEnter))for(const m of u.beforeEnter)S.push(gt(m,y,E));else S.push(gt(u.beforeEnter,y,E));return S.push(c),He(S)}).then(()=>(y.matched.forEach(u=>u.enterCallbacks={}),S=un(he,"beforeRouteEnter",y,E,j),S.push(c),He(S))).then(()=>{S=[];for(const u of i.list())S.push(gt(u,y,E));return S.push(c),He(S)}).catch(u=>ot(u,8)?u:Promise.reject(u))}function ue(y,E,S){l.list().forEach(N=>j(()=>N(y,E,S)))}function R(y,E,S,N,se){const he=k(y,E);if(he)return he;const c=E===ft,u=Ot?history.state:{};S&&(N||c?s.replace(y.fullPath,re({scroll:c&&u&&u.scroll},se)):s.push(y.fullPath,se)),a.value=y,Je(y,E,S,c),lt()}let te;function _e(){te||(te=s.listen((y,E,S)=>{if(!ho.listening)return;const N=H(y),se=O(N);if(se){ce(re(se,{replace:!0}),N).catch(oo);return}f=N;const he=a.value;Ot&&xc(Ms(he.fullPath,S.delta),Jo()),X(N,he).catch(c=>ot(c,12)?c:ot(c,2)?(ce(c.to,N).then(u=>{ot(u,20)&&!S.delta&&S.type===fo.pop&&s.go(-1,!1)}).catch(oo),Promise.reject()):(S.delta&&s.go(-S.delta,!1),oe(c,N,he))).then(c=>{c=c||R(N,he,!1),c&&(S.delta&&!ot(c,8)?s.go(-S.delta,!1):S.type===fo.pop&&ot(c,20)&&s.go(-1,!1)),ue(N,he,c)}).catch(oo)}))}let Ge=Jt(),ge=Jt(),ae;function oe(y,E,S){lt(y);const N=ge.list();return N.length?N.forEach(se=>se(y,E,S)):console.error(y),Promise.reject(y)}function tt(){return ae&&a.value!==ft?Promise.resolve():new Promise((y,E)=>{Ge.add([y,E])})}function lt(y){return ae||(ae=!y,_e(),Ge.list().forEach(([E,S])=>y?S(y):E()),Ge.reset()),y}function Je(y,E,S,N){const{scrollBehavior:se}=e;if(!Ot||!se)return Promise.resolve();const he=!S&&Ec(Ms(y.fullPath,0))||(N||!S)&&history.state&&history.state.scroll||null;return Er().then(()=>se(y,E,he)).then(c=>c&&Pc(c)).catch(c=>oe(c,y,E))}const Ee=y=>s.go(y);let Wt;const Mt=new Set,ho={currentRoute:a,listening:!0,addRoute:g,removeRoute:L,clearRoutes:t.clearRoutes,hasRoute:V,getRoutes:x,resolve:H,options:e,push:q,replace:le,go:Ee,back:()=>Ee(-1),forward:()=>Ee(1),beforeEach:r.add,beforeResolve:i.add,afterEach:l.add,onError:ge.add,isReady:tt,install(y){const E=this;y.component("RouterLink",eu),y.component("RouterView",Ti),y.config.globalProperties.$router=E,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>fe(a)}),Ot&&!Wt&&a.value===ft&&(Wt=!0,q(s.location).catch(se=>{}));const S={};for(const se in ft)Object.defineProperty(S,se,{get:()=>a.value[se],enumerable:!0});y.provide($n,E),y.provide(Ci,_r(S)),y.provide(Tn,a);const N=y.unmount;Mt.add(y),y.unmount=function(){Mt.delete(y),Mt.size<1&&(f=ft,te&&te(),te=null,a.value=ft,Wt=!1,ae=!1),N()}}};function He(y){return y.reduce((E,S)=>E.then(()=>j(S)),Promise.resolve())}return ho}function ru(e,t){const o=[],n=[],s=[],r=Math.max(t.matched.length,e.matched.length);for(let i=0;i<r;i++){const l=t.matched[i];l&&(e.matched.find(f=>$t(f,l))?n.push(l):o.push(l));const a=e.matched[i];a&&(t.matched.find(f=>$t(f,a))||s.push(a))}return[o,n,s]}const Ie=(e,t)=>{const o=e.__vccOpts||e;for(const[n,s]of t)o[n]=s;return o},iu={__name:"App",setup(e){return(t,o)=>($(),Ko(fe(Ti)))}},au=Ie(iu,[["__scopeId","data-v-0b57781d"]]),lu={class:"app-header"},cu={class:"container"},uu={class:"app-header-nav",style:{"list-style":"none"}},du={__name:"LayoutHeader",setup(e){return(t,o)=>{const n=Do("RouterLink");return $(),Q("header",lu,[b("div",cu,[b("ul",uu,[b("li",null,[P(n,{to:"/"},{default:ie(()=>[J("WebAPI")]),_:1})]),b("li",null,[P(n,{to:"/kaiWebapi2"},{default:ie(()=>[J("WebAPI2")]),_:1})]),b("li",null,[P(n,{to:"/vue3"},{default:ie(()=>[J("Vue3")]),_:1})]),b("li",null,[P(n,{to:"/download"},{default:ie(()=>[J("下載")]),_:1})]),b("li",null,[P(n,{to:"/others"},{default:ie(()=>[J("其他")]),_:1})]),b("li",null,[P(n,{to:"/dotnet7_vue3"},{default:ie(()=>[J("Dotnet7_vue3")]),_:1})]),b("li",null,[P(n,{to:"/vscode_function"},{default:ie(()=>[J("VS Code小功能")]),_:1})]),b("li",null,[P(n,{to:"/video"},{default:ie(()=>[J("Video")]),_:1})]),b("li",null,[P(n,{to:"/es6"},{default:ie(()=>[J("ES6")]),_:1})]),b("li",null,[P(n,{to:"/Naive_ui"},{default:ie(()=>[J("Naive-ui")]),_:1})]),b("li",null,[P(n,{to:"/dotnetapi_angular"},{default:ie(()=>[J("DotnetAPI_Angular")]),_:1})])])])])}}},fu=Ie(du,[["__scopeId","data-v-20ceea15"]]),pu=b("hr",null,null,-1),hu={__name:"index",setup(e){return(t,o)=>{const n=Do("RouterView");return $(),Q(z,null,[P(fu),pu,P(n)],64)}}},mu="/vue-my-note/assets/uparrow-CelNzM_b.png",gu={name:"scroll-top",data(){return{scrollTop:0,time:0,dParams:20,scrollState:0}},computed:{showTop:function(){return this.scrollTop>200}},mounted(){window.addEventListener("scroll",this.getScrollTop)},methods:{toTop(e){if(this.scrollState)return;this.scrollState=1,e.preventDefault(),document.documentElement.scrollTop||document.body.scrollTop;let t=this;this.time=setInterval(function(){t.gotoTop(t.scrollTop-t.dParams)},30)},gotoTop(e){this.dParams+=20,e=e>0?e:0,document.documentElement.scrollTop=document.body.scrollTop=window.pageYOffset=e,this.scrollTop<10&&(clearInterval(this.time),this.dParams=20,this.scrollState=0)},getScrollTop(){this.scrollTop=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop}}},bu=e=>(We("data-v-77d80545"),e=e(),Me(),e),vu=bu(()=>b("img",{src:mu},null,-1)),yu=[vu];function _u(e,t,o,n,s,r){return $(),Q("div",{class:"scrollTop",onClick:t[0]||(t[0]=(...i)=>r.toTop&&r.toTop(...i))},yu)}const Z=Ie(gu,[["render",_u],["__scopeId","data-v-77d80545"]]),wu=e=>(We("data-v-17862d76"),e=e(),Me(),e),Au=wu(()=>b("div",null,"我是WebAPI頁面",-1)),Iu=`
  ...
  `,Cu={__name:"index",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[Au,b("div",null,[b("div",{innerHTML:Iu})]),P(Z)],64))}},Tu=Ie(Cu,[["__scopeId","data-v-17862d76"]]),Su=`
...
`,Pu={__name:"TodoListEditDtoAbstract",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:Su}),P(Z)],64))}},xu=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
    //===============================================================================================//
...
`,Eu={__name:"AsyncController",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:xu}),P(Z)],64))}},Du=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
    //===============================================================================================//
...
`,Lu={__name:"AuthController",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:Du}),P(Z)],64))}},ku=e=>(We("data-v-0cf0ef1a"),e=e(),Me(),e),Ru=ku(()=>b("div",null,"這是WebAPI2",-1)),Nu={id:"Vite_to_github",class:"content"},Uu={style:{width:"15%","background-color":"white"}},Wu={style:{width:"80%"}},Mu={key:0},Hu={key:0},Ou={key:0},Fu={__name:"index",setup(e){xe(!1);let t=xe(!1),o=xe(!1);xe(!1);const n=xe(!0),s=()=>{n.value=!n.value};return Z.scrollToTop=!0,(r,i)=>($(),Q(z,null,[Ru,b("div",Nu,[b("div",Uu,[J(et(n.value)+" ",1),b("button",{onClick:s,class:so({active:n.value})},">Abstract\\TodoListEditDtoAbstract.cs",2),b("button",{onClick:s,class:so({active:n.value})},"Controller\\AsyncController.cs",2),b("button",{onClick:i[0]||(i[0]=l=>ve(o)?o.value=!fe(o):o=!fe(o))},"Controller\\AuthController.cs")]),b("div",Wu,[b("p",null,[P(it,null,{default:ie(()=>[n.value?($(),Q("div",Mu,[P(Pu)])):Rt("",!0)]),_:1})]),b("p",null,[P(it,null,{default:ie(()=>[fe(t)?($(),Q("div",Hu,[P(Eu)])):Rt("",!0)]),_:1})]),b("p",null,[P(it,null,{default:ie(()=>[fe(o)?($(),Q("div",Ou,[P(Lu)])):Rt("",!0)]),_:1})])])]),P(Z)],64))}},Vu=Ie(Fu,[["__scopeId","data-v-0cf0ef1a"]]),Bu=b("div",null,"我是RabbitVue3頁面",-1),Gu=`
...
`,Si={__name:"_4_deployVite",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:Ju}),P(Z)],64))}},Qu=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
//===============================================================================================//
...
`,Zu={__name:"_10_vue3_is",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:Qu}),P(Z)],64))}},Yu=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
//===============================================================================================//
  import HelloWorld from './components/HelloWorld.vue'
...
`,Xu={__name:"_11_vue3_is",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:Yu}),P(Z)],64))}},Zs={__name:"HelloWorld",props:["msg2"],emits:["foo"],setup(e,{emit:t}){const o=t;return setTimeout(()=>{o("foo","onFoo")},2e3),(n,s)=>($(),Q("div",null,[en(n.$slots,"default",{},()=>[J("5.HelloWorld.vue")]),J(" "+et(e.msg2)+" ",1),en(n.$slots,"default"),en(n.$slots,"footer",{msg3:" + msg3 footer props"},()=>[J("footer")])]))}},Re=e=>(We("data-v-3a0fa83b"),e=e(),Me(),e),ed=Re(()=>b("div",null,"這是其他頁",-1)),td=Re(()=>b("div",null,"3.2222",-1)),od=Re(()=>b("div",null,"4.2222",-1)),nd=Re(()=>b("div",null,"5.App傳遞的默認插槽",-1)),sd={id:"Vite_to_github",class:"content"},rd=Re(()=>b("div",null,[J("1.Vue3 CRUD + bootstrap "),b("a",{href:"https://www.youtube.com/watch?v=PrKh6GemOyg",target:"_blank"}," https://www.youtube.com/watch?v=PrKh6GemOyg ")],-1)),id=Re(()=>b("div",null,[J("2.Vue3 學習筆記 "),b("a",{href:"https://hackmd.io/@Lin-Jay/S1xju_nKO",target:"_blank"}," https://hackmd.io/@Lin-Jay/S1xju_nKO ")],-1)),ad=Re(()=>b("div",null,[J("3.Build app using Vue JS, .NET Core Web API and Microsoft SQL Server(create Azure) "),b("a",{href:"https://www.youtube.com/watch?v=TMmhECU3rHs",target:"_blank"}," https://www.youtube.com/watch?v=TMmhECU3rHs ")],-1)),ld=Re(()=>b("a",{href:"https://www.youtube.com/watch?v=yo2bMGnIKE8",target:"_blank"}," https://www.youtube.com/watch?v=yo2bMGnIKE8 ",-1)),cd={key:0},ud=zo('<div data-v-3a0fa83b>5.先學 axios 基礎與封裝管理 API <a href="https://ithelp.ithome.com.tw/articles/10304656" target="_blank" data-v-3a0fa83b> https://ithelp.ithome.com.tw/articles/10304656 </a></div><div data-v-3a0fa83b>6.[C#][ASP.NET] Web API 開發心得 (7) - 使用 Token 進行 API 授權驗證 <a href="https://ithelp.ithome.com.tw/articles/10199102" target="_blank" data-v-3a0fa83b> https://ithelp.ithome.com.tw/articles/10199102 </a></div><div data-v-3a0fa83b>7.Poy Chang Trial and Error <a href="https://blog.poychang.net/categories/" target="_blank" data-v-3a0fa83b> https://blog.poychang.net/categories/ </a></div><div data-v-3a0fa83b>8.阿里巴巴向量圖標庫: iconfont <a href="https://www.iconfont.cn/" target="_blank" data-v-3a0fa83b> https://www.iconfont.cn/ </a></div><div data-v-3a0fa83b>9.VueUse 中文文檔 <a href="https://vueuse.pages.dev/" target="_blank" data-v-3a0fa83b> https://vueuse.pages.dev/ </a></div><div data-v-3a0fa83b>9.vue3 is我意想不到的用法 <a href="https://segmentfault.com/a/1190000044532342" target="_blank" data-v-3a0fa83b> https://segmentfault.com/a/1190000044532342 </a></div>',6),dd=Re(()=>b("a",{href:"https://blog.csdn.net/kuang_nu/article/details/128834690",target:"_blank"}," https://blog.csdn.net/kuang_nu/article/details/128834690 ",-1)),fd={key:0},pd=Re(()=>b("a",{href:"https://www.bilibili.com/video/BV166421Z7nU/",target:"_blank"}," https://www.bilibili.com/video/BV166421Z7nU/ ",-1)),hd={key:0},md=Re(()=>b("div",null,[J("12.Master xUnit Like A Pro in Under 10 Minutes! "),b("a",{href:"https://www.youtube.com/watch?v=rohq-Wqj0yI",target:"_blank"}," https://www.youtube.com/watch?v=rohq-Wqj0yI ")],-1)),gd=Re(()=>b("div",null,[J("13.Native UI - 表單 "),b("a",{href:"https://www.naiveui.com/zh-CN/os-theme/components/form#inline.vue",target:"_blank"}," https://www.naiveui.com/zh-CN/os-theme/components/form#inline.vue ")],-1)),bd=Re(()=>b("div",null,[J("14.Vue3 如何用 defineModel 實作 props/ emit 的父子元件傳值，讓傳值變得更方便簡單 "),b("a",{href:"https://muki.tw/vmodel-definemodel-props-emit/",target:"_blank"}," https://muki.tw/vmodel-definemodel-props-emit/ ")],-1)),vd=Re(()=>b("div",null,[J("15.Vue3 獲取子組件dom "),b("a",{href:"https://wenku.csdn.net/answer/6j4iqoam25?ydreferer=aHR0cHM6Ly93d3cuZ29vZ2xlLmNvbS8%3D",target:"_blank"}," https://wenku.csdn.net/answer/6j4iqoam25?ydreferer=aHR0cHM6Ly93d3cuZ29vZ2xlLmNvbS8%3D ")],-1)),yd={__name:"index",setup(e){let t=xe(!1),o=xe(!1),n=xe(!1);const s=xe("1.Hello Vue3 + Vite"),r=Fe("div",{style:{color:"red"}},[Fe("span","1.Hello World")],[Fe("p","1.這是一個標籤")]);setTimeout(()=>{s.value="3.111"},2e3);const i=f=>Fe("div",{style:{color:"red"}},f.count),l=(f,{slots:d})=>{var h,g;const p=xe("4.aaa");return Fe("div",{style:{color:"red"},onClick(){console.log("click")},onMousedown(){console.log("mousedown")}},[(h=d==null?void 0:d.header)==null?void 0:h.call(d,p.value),"4.container",(g=d==null?void 0:d.default)==null?void 0:g.call(d)])},a=(f,{slots:d})=>Fe(Zs,{msg2:"App傳遞的msg2",onFoo(p){console.log("響應的事件foo",p)}},{default:d.default,footer:()=>Fe(Zs,null,{default:()=>Fe("div","5.嵌套的默認插槽"),footer:({msg3:p})=>Fe("div","5.嵌套的footer"+p)})});return Z.scrollToTop=!0,(f,d)=>($(),Q(z,null,[ed,($(),Ko(La(fe(r)))),P(i,{count:3.1},{default:ie(()=>[td]),_:1}),P(l,{count:4.1},{header:ie(p=>[b("div",null,"4.header "+et(p),1)]),default:ie(()=>[od]),_:1}),P(a,null,{default:ie(()=>[nd]),_:1}),b("div",sd,[rd,id,ad,b("div",null,[J("4.How to Deploy Your Vite App to Github Pages "),ld,b("button",{onClick:d[0]||(d[0]=p=>ve(t)?t.value=!fe(t):t=!fe(t))},"Toggle"),P(it,null,{default:ie(()=>[fe(t)?($(),Q("div",cd,[P(Si)])):Rt("",!0)]),_:1})]),ud,b("div",null,[J("10.Vue3 動態組件 標籤和:is 的用法 "),dd,b("button",{onClick:d[1]||(d[1]=p=>ve(o)?o.value=!fe(o):o=!fe(o))},"Toggle"),P(it,null,{default:ie(()=>[fe(o)?($(),Q("div",fd,[P(Zu)])):Rt("",!0)]),_:1})]),b("div",null,[J("11.Vue3 h函數的使用(必看) "),pd,b("button",{onClick:d[2]||(d[2]=p=>ve(n)?n.value=!fe(n):n=!fe(n))},"Toggle"),P(it,null,{default:ie(()=>[fe(n)?($(),Q("div",hd,[P(Xu)])):Rt("",!0)]),_:1})]),md,gd,bd,vd]),P(Z)],64))}},_d=Ie(yd,[["__scopeId","data-v-3a0fa83b"]]),Pi=e=>(We("data-v-c0da6ecf"),e=e(),Me(),e),wd=Pi(()=>b("div",null,[b("h2",null,"Dotnet7_vue3"),b("a",{href:"https://www.youtube.com/watch?v=LlYhPO8Ti2U",target:"_blank"}," https://www.youtube.com/watch?v=LlYhPO8Ti2U "),b("div",null,".NET7 Web API | SQL Database | VueJS(3.0) - Composition API | CRUD")],-1)),Ad={class:"container"},Id={class:"app-header-nav",style:{"list-style":"none"}},Cd=Pi(()=>b("div",null,null,-1)),Td={__name:"index",setup(e){return Z.scrollToTop=!0,(t,o)=>{const n=Do("RouterLink"),s=Do("RouterView");return $(),Q(z,null,[wd,b("div",null,[b("div",Ad,[b("ul",Id,[b("li",null,[P(n,{to:"/_beach_info"},{default:ie(()=>[J("_Beach_Info.vue")]),_:1})]),b("li",null,[P(n,{to:"/addbeach"},{default:ie(()=>[J("AddBeach.vue")]),_:1})]),b("li",null,[P(n,{to:"/beachList"},{default:ie(()=>[J("BeachList.vue")]),_:1})]),b("li",null,[P(n,{to:"/editbeach"},{default:ie(()=>[J("EditBeach.vue")]),_:1})]),b("li",null,[P(n,{to:"/routerbeach"},{default:ie(()=>[J("router_Beach.vue")]),_:1})]),b("li",null,[P(n,{to:"/confirmDeletePopup"},{default:ie(()=>[J("ConfirmDeletePopup.vue")]),_:1})])])]),P(s),Cd]),P(Z)],64)}}},Sd=Ie(Td,[["__scopeId","data-v-c0da6ecf"]]),Pd=e=>(We("data-v-faca44a6"),e=e(),Me(),e),xd=Pd(()=>b("div",null,"這是_Beach_Info",-1)),Ed=`
...
`,Dd={__name:"_Beach_Info",setup(e){return(t,o)=>($(),Q(z,null,[xd,b("div",{class:"content"},[b("pre",null,"      "+et(Ed)+`
    `)])],64))}},Ys=Ie(Dd,[["__scopeId","data-v-faca44a6"]]),Ld=e=>(We("data-v-315d8245"),e=e(),Me(),e),kd=Ld(()=>b("div",null,"這是AddBeach",-1)),Rd=`
  <"script setup
      import axios from 'axios';
      import {reactive} from 'vue';
...
`,Nd={__name:"AddBeach",setup(e){return(t,o)=>($(),Q(z,null,[kd,b("div",{class:"content"},[b("pre",null,"      "+et(Rd)+`
    `)])],64))}},Ud=Ie(Nd,[["__scopeId","data-v-315d8245"]]),Wd=e=>(We("data-v-21c2ba9b"),e=e(),Me(),e),Md=Wd(()=>b("div",null,"這是BeachList",-1)),Hd=`
    <"script setup>
    import { onMounted, ref } from 'vue';
    import axios from 'axios'
...
`,Od={__name:"BeachList",setup(e){return(t,o)=>($(),Q(z,null,[Md,b("div",{class:"content"},[b("pre",null,"      "+et(Hd)+`
    `)])],64))}},Fd=Ie(Od,[["__scopeId","data-v-21c2ba9b"]]),Vd=e=>(We("data-v-3763e4f1"),e=e(),Me(),e),Bd=Vd(()=>b("div",null,"這是EditBeach",-1)),Gd=`
    <"script setup>
        import axios from 'axios';
...
`,jd={__name:"EditBeach",setup(e){return(t,o)=>($(),Q(z,null,[Bd,b("div",{class:"content"},[b("pre",null,"      "+et(Gd)+`
    `)])],64))}},$d=Ie(jd,[["__scopeId","data-v-3763e4f1"]]),Kd=e=>(We("data-v-f0f2e55e"),e=e(),Me(),e),zd=Kd(()=>b("div",null,"這是_router_Beach",-1)),qd=`
...
`,Jd={__name:"router_Beach",setup(e){return(t,o)=>($(),Q(z,null,[zd,b("div",{class:"content"},[b("pre",null,"      "+et(qd)+`
...
`,ef={__name:"ConfirmDeletePopup",setup(e){return(t,o)=>($(),Q(z,null,[Yd,b("div",{class:"content"},[b("pre",null,`      這放在components\\
      由BeachList 呼叫
      `+et(Xd)+`
...
`,nf={__name:"_2_vscode",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[b("div",{innerHTML:of}),P(Z)],64))}},Kn=e=>(We("data-v-7775a5f3"),e=e(),Me(),e),sf=Kn(()=>b("div",null,"這是VS Code 功能頁",-1)),rf={id:"Vite_to_github",class:"content"},af=Kn(()=>b("div",null,[J("1.vS Code文件標簽欄多行顯示 "),b("a",{href:"https://blog.csdn.net/mj475002864/article/details/115456004",target:"_blank"}," https://blog.csdn.net/mj475002864/article/details/115456004 "),b("p",null,"ctrl + shift + p => 查詢 Open Workspace Settings => Wrap Tabs 打勾 ")],-1)),lf={key:0},cf=Kn(()=>b("div",null,[J("3.vs code 開發Extension "),b("p",null,"TypeScript Vue Plugin(Volar)"),b("p",null,"Vue Language Features"),b("p",null,"Vue - Official")],-1)),uf={__name:"index",setup(e){let t=xe(!1);return Z.scrollToTop=!0,(o,n)=>($(),Q(z,null,[sf,b("div",rf,[af,b("div",null,[J("2.vs code 快捷鍵 "),b("button",{onClick:n[0]||(n[0]=s=>ve(t)?t.value=!fe(t):t=!fe(t))},"Toggle"),P(it,null,{default:ie(()=>[fe(t)?($(),Q("div",lf,[P(nf)])):Rt("",!0)]),_:1})]),cf]),P(Z)],64))}},df=Ie(uf,[["__scopeId","data-v-7775a5f3"]]),ff=zo('<div data-v-bb9159e2>vue3+Naive UI</div><div id="Vite_to_github" class="content" data-v-bb9159e2><div data-v-bb9159e2>1.ue3+Naive UI數據表格基本使用方式 <a href="https://blog.csdn.net/weixin_54570626/article/details/129407702" target="_blank" data-v-bb9159e2> https://blog.csdn.net/weixin_54570626/article/details/129407702 </a></div><div data-v-bb9159e2>2.naive ui 數據表格操作加入兩個按鈕解決辦法 <a href="https://blog.csdn.net/uglyduckling0412/article/details/131438996" target="_blank" data-v-bb9159e2> https://blog.csdn.net/uglyduckling0412/article/details/131438996 </a></div><div data-v-bb9159e2>3.Naive UI之Data Table <a href="https://blog.csdn.net/aliceyang2012/article/details/127801611" target="_blank" data-v-bb9159e2> https://blog.csdn.net/aliceyang2012/article/details/127801611 </a></div><div data-v-bb9159e2>4.vue3結合naiveui的表單規則寫法（回調） <a href="https://www.cnblogs.com/lingern/p/16190795.html" target="_blank" data-v-bb9159e2> https://www.cnblogs.com/lingern/p/16190795.html </a></div></div>',2),pf={__name:"index",setup(e){return xe(!1),Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[ff,P(Z)],64))}},hf=Ie(pf,[["__scopeId","data-v-bb9159e2"]]),mf=zo('<div data-v-97fd3d78>這是影音頁</div><div id="Vite_to_github" class="content" data-v-97fd3d78><div data-v-97fd3d78>1.Vue3 CRUD + bootstrap <a href="https://www.youtube.com/watch?v=PrKh6GemOyg" target="_blank" data-v-97fd3d78> https://www.youtube.com/watch?v=PrKh6GemOyg </a></div><div data-v-97fd3d78>2.後台課程管理系統-Vue3版 <a href="https://www.youtube.com/watch?v=yZMTHoGSuVQ&amp;list=PL_vrngOaamYsIovhZ3Cd9M2vPhm3yRTnG" target="_blank" data-v-97fd3d78> https://www.youtube.com/watch?v=yZMTHoGSuVQ&amp;list=PL_vrngOaamYsIovhZ3Cd9M2vPhm3yRTnG </a></div><div data-v-97fd3d78>3.2024年不看后悔的Vue3+.NET7+WebAPI从零手写后台管理系统 <a href="https://www.bilibili.com/video/BV1Km411o7ip?p=1&amp;vd_source=1a5937a80fc962029ba6a7b9ee9a1654" target="_blank" data-v-97fd3d78> https://www.bilibili.com/video/BV1Km411o7ip?p=1&amp;vd_source=1a5937a80fc962029ba6a7b9ee9a1654 </a><a href="https://search.bilibili.com/all?vt=75651059&amp;keyword=2024%E5%B9%B4%E4%B8%8D%E7%9C%8B%E5%90%8E%E6%82%94%E7%9A%84Vue3%2B.NET7%2BWebAPI&amp;from_source=webtop_search&amp;spm_id_from=333.1007&amp;search_source=5" target="_blank" data-v-97fd3d78> https://search.bilibili.com/all?vt=75651059&amp;keyword=2024%E5%B9%B4%E4%B8%8D%E7%9C%8B%E5%90%8E%E6%82%94%E7%9A%84Vue3%2B.NET7%2BWebAPI&amp;from_source=webtop_search&amp;spm_id_from=333.1007&amp;search_source=5 </a></div><div data-v-97fd3d78>4.2023全新C#完全零基础入门教程（附源码） <a href="https://www.bilibili.com/read/cv25507935/" target="_blank" data-v-97fd3d78> https://www.bilibili.com/read/cv25507935/ </a></div></div>',2),gf={__name:"index",setup(e){return xe(!1),Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[mf,P(Z)],64))}},bf=Ie(gf,[["__scopeId","data-v-97fd3d78"]]),vf=b("div",null,"【尚硅谷】ES6教程——涵盖ES6-ES11",-1),yf=`
  <div id="Vue3-rabbit" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
    <pre>
//===============================================================================================//
...
`,_f={__name:"index",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[vf,b("div",{innerHTML:yf}),P(Z)],64))}},wf=e=>(We("data-v-578d3ec3"),e=e(),Me(),e),Af=wf(()=>b("div",null,"我是DotnetAPI_Angular頁面",-1)),If=`
    <div id="content" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
    <pre>
  ...
  `,Cf={__name:"index",setup(e){return Z.scrollToTop=!0,(t,o)=>($(),Q(z,null,[Af,b("div",null,[b("div",{innerHTML:If})]),P(Z)],64))}},Tf=Ie(Cf,[["__scopeId","data-v-578d3ec3"]]),Sf=su({history:Rc("/vue-my-note/"),routes:[{path:"/",component:hu,children:[{path:"",component:Tu},{path:"/kaiWebapi2",component:Vu},{path:"/vue3",component:ju},{path:"/download",component:qu},{path:"/others",component:_d,children:[{path:"/_4_deployVite",component:Si}]},{path:"/dotnet7_vue3",component:Sd,children:[{path:"",component:Ys},{path:"/_beach_info",component:Ys},{path:"/addbeach",component:Ud},{path:"/beachList",component:Fd},{path:"/editbeach",component:$d},{path:"/routerbeach",component:Qd},{path:"/confirmDeletePopup",component:tf}]},{path:"/vscode_function",component:df},{path:"/Naive_ui",component:hf},{path:"/video",component:bf},{path:"/es6",component:_f},{path:"/dotnetapi_angular",component:Tf}]}]}),zn=Zl(au);zn.use(oc());zn.use(Sf);zn.mount("#app");
