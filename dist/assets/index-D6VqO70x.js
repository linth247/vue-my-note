 ...
 */const tc=Symbol();var Us;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(Us||(Us={}));function oc(){const e=Bi(!0),t=e.run(()=>Ue({}));let o=[],n=[];const s=Ar({install(r){s._a=r,r.provide(tc,s),r.config.globalProperties.$pinia=s,n.forEach(i=>o.push(i)),n=[]},use(r){return!this._a&&!ec?n.push(r):o.push(r),this},_p:o,_a:null,_e:e,_s:new Map,state:t});return s}/*!
  ...
  */const Ht=typeof document<"u";function nc(e){return e.__esModule||e[Symbol.toStringTag]==="Module"}const ne=Object.assign;function an(e,t){const o={};for(const n in t){const s=t[n];o[n]=qe(s)?s.map(e):e(s)}return o}const oo=()=>{},qe=Array.isArray,fi=/#/g,sc=/&/g,rc=/\//g,ic=/=/g,ac=/\?/g,pi=/\+/g,lc=/%5B/g,cc=/%5D/g,hi=/%5E/g,uc=/%60/g,mi=/%7B/g,dc=/%7C/g,gi=/%7D/g,fc=/%20/g;function jn(e){return encodeURI(""+e).replace(dc,"|").replace(lc,"[").replace(cc,"]")}function pc(e){return jn(e).replace(mi,"{").replace(gi,"}").replace(hi,"^")}function An(e){return jn(e).replace(pi,"%2B").replace(fc,"+").replace(fi,"%23").replace(sc,"%26").replace(uc,"`").replace(mi,"{").replace(gi,"}").replace(hi,"^")}function hc(e){return An(e).replace(ic,"%3D")}function mc(e){return jn(e).replace(fi,"%23").replace(ac,"%3F")}function gc(e){return e==null?"":mc(e).replace(rc,"%2F")}function uo(e){try{return decodeURIComponent(""+e)}catch{}return""+e}const bc=/\/$/,vc=e=>e.replace(bc,"");function ln(e,t,o="/"){let n,s={},r="",i="";const l=t.indexOf("#");let a=t.indexOf("?");return l<a&&l>=0&&(a=-1),a>-1&&(n=t.slice(0,a),r=t.slice(a+1,l>-1?l:t.length),s=e(r)),l>-1&&(n=n||t.slice(0,l),i=t.slice(l,t.length)),n=Ac(n??t,o),{fullPath:n+(r&&"?")+r+i,path:n,query:s,hash:uo(i)}}function yc(e,t){const o=t.query?e(t.query):"";return t.path+(o&&"?")+o+(t.hash||"")}function Ns(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function _c(e,t,o){const n=t.matched.length-1,s=o.matched.length-1;return n>-1&&n===s&&$t(t.matched[n],o.matched[s])&&bi(t.params,o.params)&&e(t.query)===e(o.query)&&t.hash===o.hash}function $t(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function bi(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(const o in e)if(!wc(e[o],t[o]))return!1;return!0}function wc(e,t){return qe(e)?Ws(e,t):qe(t)?Ws(t,e):e===t}function Ws(e,t){return qe(t)?e.length===t.length&&e.every((o,n)=>o===t[n]):e.length===1&&e[0]===t}function Ac(e,t){if(e.startsWith("/"))return e;if(!e)return t;const o=t.split("/"),n=e.split("/"),s=n[n.length-1];(s===".."||s===".")&&n.push("");let r=o.length-1,i,l;for(i=0;i<n.length;i++)if(l=n[i],l!==".")if(l==="..")r>1&&r--;else break;return o.slice(0,r).join("/")+"/"+n.slice(i).join("/")}const dt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var fo;(function(e){e.pop="pop",e.push="push"})(fo||(fo={}));var no;(function(e){e.back="back",e.forward="forward",e.unknown=""})(no||(no={}));function Ic(e){if(!e)if(Ht){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),vc(e)}const Tc=/^[^#]+#/;function Cc(e,t){return e.replace(Tc,"#")+t}function Sc(e,t){const o=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-o.left-(t.left||0),top:n.top-o.top-(t.top||0)}}const zo=()=>({left:window.scrollX,top:window.scrollY});function Pc(e){let t;if("el"in e){const o=e.el,n=typeof o=="string"&&o.startsWith("#"),s=typeof o=="string"?n?document.getElementById(o.slice(1)):document.querySelector(o):o;if(!s)return;t=Sc(s,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function Rs(e,t){return(history.state?history.state.position-t:-1)+e}const In=new Map;function xc(e,t){In.set(e,t)}function Ec(e){const t=In.get(e);return In.delete(e),t}let Dc=()=>location.protocol+"//"+location.host;function vi(e,t){const{pathname:o,search:n,hash:s}=t,r=e.indexOf("#");if(r>-1){let l=s.includes(e.slice(r))?e.slice(r).length:1,a=s.slice(l);return a[0]!=="/"&&(a="/"+a),Ns(a,"")}return Ns(o,e)+n+s}function Lc(e,t,o,n){let s=[],r=[],i=null;const l=({state:h})=>{const g=vi(e,location),D=o.value,P=t.value;let B=0;if(h){if(o.value=g,t.value=h,i&&i===D){i=null;return}B=P?h.position-P.position:0}else n(g);s.forEach(H=>{H(o.value,D,{delta:B,type:fo.pop,direction:B?B>0?no.forward:no.back:no.unknown})})};function a(){i=o.value}function f(h){s.push(h);const g=()=>{const D=s.indexOf(h);D>-1&&s.splice(D,1)};return r.push(g),g}function d(){const{history:h}=window;h.state&&h.replaceState(ne({},h.state,{scroll:zo()}),"")}function p(){for(const h of r)h();r=[],window.removeEventListener("popstate",l),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",l),window.addEventListener("beforeunload",d,{passive:!0}),{pauseListeners:a,listen:f,destroy:p}}function Ms(e,t,o,n=!1,s=!1){return{back:e,current:t,forward:o,replaced:n,position:window.history.length,scroll:s?zo():null}}function kc(e){const{history:t,location:o}=window,n={value:vi(e,o)},s={value:t.state};s.value||r(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function r(a,f,d){const p=e.indexOf("#"),h=p>-1?(o.host&&document.querySelector("base")?e:e.slice(p))+a:Dc()+e+a;try{t[d?"replaceState":"pushState"](f,"",h),s.value=f}catch(g){console.error(g),o[d?"replace":"assign"](h)}}function i(a,f){const d=ne({},t.state,Ms(s.value.back,a,s.value.forward,!0),f,{position:s.value.position});r(a,d,!0),n.value=a}function l(a,f){const d=ne({},s.value,t.state,{forward:a,scroll:zo()});r(d.current,d,!0);const p=ne({},Ms(n.value,a,null),{position:d.position+1},f);r(a,p,!1),n.value=a}return{location:n,state:s,push:l,replace:i}}function Uc(e){e=Ic(e);const t=kc(e),o=Lc(e,t.state,t.location,t.replace);function n(r,i=!0){i||o.pauseListeners(),history.go(r)}const s=ne({location:"",base:e,go:n,createHref:Cc.bind(null,e)},t,o);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>t.state.value}),s}function Nc(e){return typeof e=="string"||e&&typeof e=="object"}function yi(e){return typeof e=="string"||typeof e=="symbol"}const _i=Symbol("");var Hs;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(Hs||(Hs={}));function Kt(e,t){return ne(new Error,{type:e,[_i]:!0},t)}function ot(e,t){return e instanceof Error&&_i in e&&(t==null||!!(e.type&t))}const Os="[^/]+?",Wc={sensitive:!1,strict:!1,start:!0,end:!0},Rc=/[.+*?^${}()[\]/\\]/g;function Mc(e,t){const o=ne({},Wc,t),n=[];let s=o.start?"^":"";const r=[];for(const f of e){const d=f.length?[]:[90];o.strict&&!f.length&&(s+="/");for(let p=0;p<f.length;p++){const h=f[p];let g=40+(o.sensitive?.25:0);if(h.type===0)p||(s+="/"),s+=h.value.replace(Rc,"\\$&"),g+=40;else if(h.type===1){const{value:D,repeatable:P,optional:B,regexp:H}=h;r.push({name:D,repeatable:P,optional:B});const W=H||Os;if(W!==Os){g+=10;try{new RegExp(`(${W})`)}catch(K){throw new Error(`Invalid custom RegExp for param "${D}" (${W}): `+K.message)}}let L=P?`((?:${W})(?:/(?:${W}))*)`:`(${W})`;p||(L=B&&f.length<2?`(?:/${L})`:"/"+L),B&&(L+="?"),s+=L,g+=20,B&&(g+=-8),P&&(g+=-20),W===".*"&&(g+=-50)}d.push(g)}n.push(d)}if(o.strict&&o.end){const f=n.length-1;n[f][n[f].length-1]+=.7000000000000001}o.strict||(s+="/?"),o.end?s+="$":o.strict&&(s+="(?:/|$)");const i=new RegExp(s,o.sensitive?"":"i");function l(f){const d=f.match(i),p={};if(!d)return null;for(let h=1;h<d.length;h++){const g=d[h]||"",D=r[h-1];p[D.name]=g&&D.repeatable?g.split("/"):g}return p}function a(f){let d="",p=!1;for(const h of e){(!p||!d.endsWith("/"))&&(d+="/"),p=!1;for(const g of h)if(g.type===0)d+=g.value;else if(g.type===1){const{value:D,repeatable:P,optional:B}=g,H=D in f?f[D]:"";if(qe(H)&&!P)throw new Error(`Provided param "${D}" is an array but it is not repeatable (* or + modifiers)`);const W=qe(H)?H.join("/"):H;if(!W)if(B)h.length<2&&(d.endsWith("/")?d=d.slice(0,-1):p=!0);else throw new Error(`Missing required param "${D}"`);d+=W}}return d||"/"}return{re:i,score:n,keys:r,parse:l,stringify:a}}function Hc(e,t){let o=0;for(;o<e.length&&o<t.length;){const n=t[o]-e[o];if(n)return n;o++}return e.length<t.length?e.length===1&&e[0]===80?-1:1:e.length>t.length?t.length===1&&t[0]===80?1:-1:0}function wi(e,t){let o=0;const n=e.score,s=t.score;for(;o<n.length&&o<s.length;){const r=Hc(n[o],s[o]);if(r)return r;o++}if(Math.abs(s.length-n.length)===1){if(Fs(n))return 1;if(Fs(s))return-1}return s.length-n.length}function Fs(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const Oc={type:0,value:""},Fc=/[a-zA-Z0-9_]/;function Bc(e){if(!e)return[[]];if(e==="/")return[[Oc]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(g){throw new Error(`ERR (${o})/"${f}": ${g}`)}let o=0,n=o;const s=[];let r;function i(){r&&s.push(r),r=[]}let l=0,a,f="",d="";function p(){f&&(o===0?r.push({type:0,value:f}):o===1||o===2||o===3?(r.length>1&&(a==="*"||a==="+")&&t(`A repeatable param (${f}) must be alone in its segment. eg: '/:ids+.`),r.push({type:1,value:f,regexp:d,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):t("Invalid state to consume buffer"),f="")}function h(){f+=a}for(;l<e.length;){if(a=e[l++],a==="\\"&&o!==2){n=o,o=4;continue}switch(o){case 0:a==="/"?(f&&p(),i()):a===":"?(p(),o=1):h();break;case 4:h(),o=n;break;case 1:a==="("?o=2:Fc.test(a)?h():(p(),o=0,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case 2:a===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+a:o=3:d+=a;break;case 3:p(),o=0,a!=="*"&&a!=="?"&&a!=="+"&&l--,d="";break;default:t("Unknown state");break}}return o===2&&t(`Unfinished custom RegExp for param "${f}"`),p(),i(),s}function Vc(e,t,o){const n=Mc(Bc(e.path),o),s=ne(n,{record:e,parent:t,children:[],alias:[]});return t&&!s.record.aliasOf==!t.record.aliasOf&&t.children.push(s),s}function Gc(e,t){const o=[],n=new Map;t=Gs({strict:!1,end:!0,sensitive:!1},t);function s(p){return n.get(p)}function r(p,h,g){const D=!g,P=jc(p);P.aliasOf=g&&g.record;const B=Gs(t,p),H=[P];if("alias"in p){const K=typeof p.alias=="string"?[p.alias]:p.alias;for(const ae of K)H.push(ne({},P,{components:g?g.record.components:P.components,path:ae,aliasOf:g?g.record:P}))}let W,L;for(const K of H){const{path:ae}=K;if(h&&ae[0]!=="/"){const O=h.record.path,le=O[O.length-1]==="/"?"":"/";K.path=h.record.path+(ae&&le+ae)}if(W=Vc(K,h,B),g?g.alias.push(W):(L=L||W,L!==W&&L.alias.push(W),D&&p.name&&!Vs(W)&&i(p.name)),Ai(W)&&a(W),P.children){const O=P.children;for(let le=0;le<O.length;le++)r(O[le],W,g&&g.children[le])}g=g||W}return L?()=>{i(L)}:oo}function i(p){if(yi(p)){const h=n.get(p);h&&(n.delete(p),o.splice(o.indexOf(h),1),h.children.forEach(i),h.alias.forEach(i))}else{const h=o.indexOf(p);h>-1&&(o.splice(h,1),p.record.name&&n.delete(p.record.name),p.children.forEach(i),p.alias.forEach(i))}}function l(){return o}function a(p){const h=qc(p,o);o.splice(h,0,p),p.record.name&&!Vs(p)&&n.set(p.record.name,p)}function f(p,h){let g,D={},P,B;if("name"in p&&p.name){if(g=n.get(p.name),!g)throw Kt(1,{location:p});B=g.record.name,D=ne(Bs(h.params,g.keys.filter(L=>!L.optional).concat(g.parent?g.parent.keys.filter(L=>L.optional):[]).map(L=>L.name)),p.params&&Bs(p.params,g.keys.map(L=>L.name))),P=g.stringify(D)}else if(p.path!=null)P=p.path,g=o.find(L=>L.re.test(P)),g&&(D=g.parse(P),B=g.record.name);else{if(g=h.name?n.get(h.name):o.find(L=>L.re.test(h.path)),!g)throw Kt(1,{location:p,currentLocation:h});B=g.record.name,D=ne({},h.params,p.params),P=g.stringify(D)}const H=[];let W=g;for(;W;)H.unshift(W.record),W=W.parent;return{name:B,path:P,params:D,matched:H,meta:Kc(H)}}e.forEach(p=>r(p));function d(){o.length=0,n.clear()}return{addRoute:r,resolve:f,removeRoute:i,clearRoutes:d,getRoutes:l,getRecordMatcher:s}}function Bs(e,t){const o={};for(const n of t)n in e&&(o[n]=e[n]);return o}function jc(e){return{path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:void 0,beforeEnter:e.beforeEnter,props:$c(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}}}function $c(e){const t={},o=e.props||!1;if("component"in e)t.default=o;else for(const n in e.components)t[n]=typeof o=="object"?o[n]:o;return t}function Vs(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Kc(e){return e.reduce((t,o)=>ne(t,o.meta),{})}function Gs(e,t){const o={};for(const n in e)o[n]=n in t?t[n]:e[n];return o}function qc(e,t){let o=0,n=t.length;for(;o!==n;){const r=o+n>>1;wi(e,t[r])<0?n=r:o=r+1}const s=zc(e);return s&&(n=t.lastIndexOf(s,n-1)),n}function zc(e){let t=e;for(;t=t.parent;)if(Ai(t)&&wi(e,t)===0)return t}function Ai({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Jc(e){const t={};if(e===""||e==="?")return t;const n=(e[0]==="?"?e.slice(1):e).split("&");for(let s=0;s<n.length;++s){const r=n[s].replace(pi," "),i=r.indexOf("="),l=uo(i<0?r:r.slice(0,i)),a=i<0?null:uo(r.slice(i+1));if(l in t){let f=t[l];qe(f)||(f=t[l]=[f]),f.push(a)}else t[l]=a}return t}function js(e){let t="";for(let o in e){const n=e[o];if(o=hc(o),n==null){n!==void 0&&(t+=(t.length?"&":"")+o);continue}(qe(n)?n.map(r=>r&&An(r)):[n&&An(n)]).forEach(r=>{r!==void 0&&(t+=(t.length?"&":"")+o,r!=null&&(t+="="+r))})}return t}function Qc(e){const t={};for(const o in e){const n=e[o];n!==void 0&&(t[o]=qe(n)?n.map(s=>s==null?null:""+s):n==null?n:""+n)}return t}const Zc=Symbol(""),$s=Symbol(""),$n=Symbol(""),Ii=Symbol(""),Tn=Symbol("");function Jt(){let e=[];function t(n){return e.push(n),()=>{const s=e.indexOf(n);s>-1&&e.splice(s,1)}}function o(){e=[]}return{add:t,list:()=>e.slice(),reset:o}}function mt(e,t,o,n,s,r=i=>i()){const i=n&&(n.enterCallbacks[s]=n.enterCallbacks[s]||[]);return()=>new Promise((l,a)=>{const f=h=>{h===!1?a(Kt(4,{from:o,to:t})):h instanceof Error?a(h):Nc(h)?a(Kt(2,{from:t,to:h})):(i&&n.enterCallbacks[s]===i&&typeof h=="function"&&i.push(h),l())},d=r(()=>e.call(n&&n.instances[s],t,o,f));let p=Promise.resolve(d);e.length<3&&(p=p.then(f)),p.catch(h=>a(h))})}function cn(e,t,o,n,s=r=>r()){const r=[];for(const i of e)for(const l in i.components){let a=i.components[l];if(!(t!=="beforeRouteEnter"&&!i.instances[l]))if(Yc(a)){const d=(a.__vccOpts||a)[t];d&&r.push(mt(d,o,n,i,l,s))}else{let f=a();r.push(()=>f.then(d=>{if(!d)return Promise.reject(new Error(`Couldn't resolve component "${l}" at "${i.path}"`));const p=nc(d)?d.default:d;i.components[l]=p;const g=(p.__vccOpts||p)[t];return g&&mt(g,o,n,i,l,s)()}))}}return r}function Yc(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function Ks(e){const t=rt($n),o=rt(Ii),n=$e(()=>{const a=ge(e.to);return t.resolve(a)}),s=$e(()=>{const{matched:a}=n.value,{length:f}=a,d=a[f-1],p=o.matched;if(!d||!p.length)return-1;const h=p.findIndex($t.bind(null,d));if(h>-1)return h;const g=qs(a[f-2]);return f>1&&qs(d)===g&&p[p.length-1].path!==g?p.findIndex($t.bind(null,a[f-2])):h}),r=$e(()=>s.value>-1&&ou(o.params,n.value.params)),i=$e(()=>s.value>-1&&s.value===o.matched.length-1&&bi(o.params,n.value.params));function l(a={}){return tu(a)?t[ge(e.replace)?"replace":"push"](ge(e.to)).catch(oo):Promise.resolve()}return{route:n,href:$e(()=>n.value.href),isActive:r,isExactActive:i,navigate:l}}const Xc=Rr({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Ks,setup(e,{slots:t}){const o=Oo(Ks(e)),{options:n}=rt($n),s=$e(()=>({[zs(e.activeClass,n.linkActiveClass,"router-link-active")]:o.isActive,[zs(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:o.isExactActive}));return()=>{const r=t.default&&t.default(o);return e.custom?r:Oe("a",{"aria-current":o.isExactActive?e.ariaCurrentValue:null,href:o.href,onClick:o.navigate,class:s.value},r)}}}),eu=Xc;function tu(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function ou(e,t){for(const o in t){const n=t[o],s=e[o];if(typeof n=="string"){if(n!==s)return!1}else if(!qe(s)||s.length!==n.length||n.some((r,i)=>r!==s[i]))return!1}return!0}function qs(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const zs=(e,t,o)=>e??t??o,nu=Rr({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:o}){const n=rt(Tn),s=$e(()=>e.route||n.value),r=rt($s,0),i=$e(()=>{let f=ge(r);const{matched:d}=s.value;let p;for(;(p=d[f])&&!p.components;)f++;return f}),l=$e(()=>s.value.matched[i.value]);Io($s,$e(()=>i.value+1)),Io(Zc,l),Io(Tn,s);const a=Ue();return To(()=>[a.value,l.value,e.name],([f,d,p],[h,g,D])=>{d&&(d.instances[p]=f,g&&g!==d&&f&&f===h&&(d.leaveGuards.size||(d.leaveGuards=g.leaveGuards),d.updateGuards.size||(d.updateGuards=g.updateGuards))),f&&d&&(!g||!$t(d,g)||!h)&&(d.enterCallbacks[p]||[]).forEach(P=>P(f))},{flush:"post"}),()=>{const f=s.value,d=e.name,p=l.value,h=p&&p.components[d];if(!h)return Js(o.default,{Component:h,route:f});const g=p.props[d],D=g?g===!0?f.params:typeof g=="function"?g(f):g:null,B=Oe(h,ne({},D,t,{onVnodeUnmounted:H=>{H.component.isUnmounted&&(p.instances[d]=null)},ref:a}));return Js(o.default,{Component:B,route:f})||B}}});function Js(e,t){if(!e)return null;const o=e(t);return o.length===1?o[0]:o}const Ti=nu;function su(e){const t=Gc(e.routes,e),o=e.parseQuery||Jc,n=e.stringifyQuery||js,s=e.history,r=Jt(),i=Jt(),l=Jt(),a=ua(dt);let f=dt;Ht&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=an.bind(null,v=>""+v),p=an.bind(null,gc),h=an.bind(null,uo);function g(v,x){let S,N;return yi(v)?(S=t.getRecordMatcher(v),N=x):N=v,t.addRoute(N,S)}function D(v){const x=t.getRecordMatcher(v);x&&t.removeRoute(x)}function P(){return t.getRoutes().map(v=>v.record)}function B(v){return!!t.getRecordMatcher(v)}function H(v,x){if(x=ne({},x||a.value),typeof v=="string"){const u=ln(o,v,x.path),m=t.resolve({path:u.path},x),y=s.createHref(u.fullPath);return ne(u,m,{params:h(m.params),hash:uo(u.hash),redirectedFrom:void 0,href:y})}let S;if(v.path!=null)S=ne({},v,{path:ln(o,v.path,x.path).path});else{const u=ne({},v.params);for(const m in u)u[m]==null&&delete u[m];S=ne({},v,{params:p(u)}),x.params=p(x.params)}const N=t.resolve(S,x),oe=v.hash||"";N.params=d(h(N.params));const pe=yc(n,ne({},v,{hash:pc(oe),path:N.path})),c=s.createHref(pe);return ne({fullPath:pe,hash:oe,query:n===js?Qc(v.query):v.query||{}},N,{redirectedFrom:void 0,href:c})}function W(v){return typeof v=="string"?ln(o,v,a.value.path):ne({},v)}function L(v,x){if(f!==v)return Kt(8,{from:x,to:v})}function K(v){return le(v)}function ae(v){return K(ne(W(v),{replace:!0}))}function O(v){const x=v.matched[v.matched.length-1];if(x&&x.redirect){const{redirect:S}=x;let N=typeof S=="function"?S(v):S;return typeof N=="string"&&(N=N.includes("?")||N.includes("#")?N=W(N):{path:N},N.params={}),ne({query:v.query,hash:v.hash,params:N.path!=null?{}:v.params},N)}}function le(v,x){const S=f=H(v),N=a.value,oe=v.state,pe=v.force,c=v.replace===!0,u=O(S);if(u)return le(ne(W(u),{state:typeof u=="object"?ne({},oe,u.state):oe,force:pe,replace:c}),x||S);const m=S;m.redirectedFrom=x;let y;return!pe&&_c(n,N,S)&&(y=Kt(16,{to:m,from:N}),Je(N,N,!0,!1)),(y?Promise.resolve(y):Q(m,N)).catch(b=>ot(b)?ot(b,2)?b:at(b):X(b,m,N)).then(b=>{if(b){if(ot(b,2))return le(ne({replace:c},W(b.to),{state:typeof b.to=="object"?ne({},oe,b.to.state):oe,force:pe}),x||m)}else b=U(m,N,!0,c,oe);return ce(m,N,b),b})}function ve(v,x){const S=L(v,x);return S?Promise.reject(S):Promise.resolve()}function j(v){const x=Rt.values().next().value;return x&&typeof x.runWithContext=="function"?x.runWithContext(v):v()}function Q(v,x){let S;const[N,oe,pe]=ru(v,x);S=cn(N.reverse(),"beforeRouteLeave",v,x);for(const u of N)u.leaveGuards.forEach(m=>{S.push(mt(m,v,x))});const c=ve.bind(null,v,x);return S.push(c),Me(S).then(()=>{S=[];for(const u of r.list())S.push(mt(u,v,x));return S.push(c),Me(S)}).then(()=>{S=cn(oe,"beforeRouteUpdate",v,x);for(const u of oe)u.updateGuards.forEach(m=>{S.push(mt(m,v,x))});return S.push(c),Me(S)}).then(()=>{S=[];for(const u of pe)if(u.beforeEnter)if(qe(u.beforeEnter))for(const m of u.beforeEnter)S.push(mt(m,v,x));else S.push(mt(u.beforeEnter,v,x));return S.push(c),Me(S)}).then(()=>(v.matched.forEach(u=>u.enterCallbacks={}),S=cn(pe,"beforeRouteEnter",v,x,j),S.push(c),Me(S))).then(()=>{S=[];for(const u of i.list())S.push(mt(u,v,x));return S.push(c),Me(S)}).catch(u=>ot(u,8)?u:Promise.reject(u))}function ce(v,x,S){l.list().forEach(N=>j(()=>N(v,x,S)))}function U(v,x,S,N,oe){const pe=L(v,x);if(pe)return pe;const c=x===dt,u=Ht?history.state:{};S&&(N||c?s.replace(v.fullPath,ne({scroll:c&&u&&u.scroll},oe)):s.push(v.fullPath,oe)),a.value=v,Je(v,x,S,c),at()}let Y;function ye(){Y||(Y=s.listen((v,x,S)=>{if(!ho.listening)return;const N=H(v),oe=O(N);if(oe){le(ne(oe,{replace:!0}),N).catch(oo);return}f=N;const pe=a.value;Ht&&xc(Rs(pe.fullPath,S.delta),zo()),Q(N,pe).catch(c=>ot(c,12)?c:ot(c,2)?(le(c.to,N).then(u=>{ot(u,20)&&!S.delta&&S.type===fo.pop&&s.go(-1,!1)}).catch(oo),Promise.reject()):(S.delta&&s.go(-S.delta,!1),X(c,N,pe))).then(c=>{c=c||U(N,pe,!1),c&&(S.delta&&!ot(c,8)?s.go(-S.delta,!1):S.type===fo.pop&&ot(c,20)&&s.go(-1,!1)),ce(N,pe,c)}).catch(oo)}))}let Ve=Jt(),me=Jt(),se;function X(v,x,S){at(v);const N=me.list();return N.length?N.forEach(oe=>oe(v,x,S)):console.error(v),Promise.reject(v)}function tt(){return se&&a.value!==dt?Promise.resolve():new Promise((v,x)=>{Ve.add([v,x])})}function at(v){return se||(se=!v,ye(),Ve.list().forEach(([x,S])=>v?S(v):x()),Ve.reset()),v}function Je(v,x,S,N){const{scrollBehavior:oe}=e;if(!Ht||!oe)return Promise.resolve();const pe=!S&&Ec(Rs(v.fullPath,0))||(N||!S)&&history.state&&history.state.scroll||null;return xr().then(()=>oe(v,x,pe)).then(c=>c&&Pc(c)).catch(c=>X(c,v,x))}const xe=v=>s.go(v);let Wt;const Rt=new Set,ho={currentRoute:a,listening:!0,addRoute:g,removeRoute:D,clearRoutes:t.clearRoutes,hasRoute:B,getRoutes:P,resolve:H,options:e,push:K,replace:ae,go:xe,back:()=>xe(-1),forward:()=>xe(1),beforeEach:r.add,beforeResolve:i.add,afterEach:l.add,onError:me.add,isReady:tt,install(v){const x=this;v.component("RouterLink",eu),v.component("RouterView",Ti),v.config.globalProperties.$router=x,Object.defineProperty(v.config.globalProperties,"$route",{enumerable:!0,get:()=>ge(a)}),Ht&&!Wt&&a.value===dt&&(Wt=!0,K(s.location).catch(oe=>{}));const S={};for(const oe in dt)Object.defineProperty(S,oe,{get:()=>a.value[oe],enumerable:!0});v.provide($n,x),v.provide(Ii,yr(S)),v.provide(Tn,a);const N=v.unmount;Rt.add(v),v.unmount=function(){Rt.delete(v),Rt.size<1&&(f=dt,Y&&Y(),Y=null,a.value=dt,Wt=!1,se=!1),N()}}};function Me(v){return v.reduce((x,S)=>x.then(()=>j(S)),Promise.resolve())}return ho}function ru(e,t){const o=[],n=[],s=[],r=Math.max(t.matched.length,e.matched.length);for(let i=0;i<r;i++){const l=t.matched[i];l&&(e.matched.find(f=>$t(f,l))?n.push(l):o.push(l));const a=e.matched[i];a&&(t.matched.find(f=>$t(f,a))||s.push(a))}return[o,n,s]}const Te=(e,t)=>{const o=e.__vccOpts||e;for(const[n,s]of t)o[n]=s;return o},iu={__name:"App",setup(e){return(t,o)=>(q(),Ko(ge(Ti)))}},au=Te(iu,[["__scopeId","data-v-0b57781d"]]),lu={class:"app-header"},cu={class:"container"},uu={class:"app-header-nav",style:{"list-style":"none"}},du={__name:"LayoutHeader",setup(e){return(t,o)=>{const n=Do("RouterLink");return q(),te("header",lu,[_("div",cu,[_("ul",uu,[_("li",null,[k(n,{to:"/"},{default:ue(()=>[re("WebAPI")]),_:1})]),_("li",null,[k(n,{to:"/kaiWebapi2"},{default:ue(()=>[re("WebAPI2")]),_:1})]),_("li",null,[k(n,{to:"/vue3"},{default:ue(()=>[re("Vue3")]),_:1})]),_("li",null,[k(n,{to:"/download"},{default:ue(()=>[re("下載")]),_:1})]),_("li",null,[k(n,{to:"/others"},{default:ue(()=>[re("其他")]),_:1})]),_("li",null,[k(n,{to:"/dotnet7_vue3"},{default:ue(()=>[re("Dotnet7_vue3")]),_:1})]),_("li",null,[k(n,{to:"/vscode_function"},{default:ue(()=>[re("VS Code小功能")]),_:1})]),_("li",null,[k(n,{to:"/video"},{default:ue(()=>[re("Video")]),_:1})]),_("li",null,[k(n,{to:"/dotnetapi_angular"},{default:ue(()=>[re("DotnetAPI_Angular")]),_:1})])])])])}}},fu=Te(du,[["__scopeId","data-v-8dac5340"]]),pu=_("hr",null,null,-1),hu={__name:"index",setup(e){return(t,o)=>{const n=Do("RouterView");return q(),te(J,null,[k(fu),pu,k(n)],64)}}},mu="/vue-my-note/assets/uparrow-CelNzM_b.png",gu={name:"scroll-top",data(){return{scrollTop:0,time:0,dParams:20,scrollState:0}},computed:{showTop:function(){return this.scrollTop>200}},mounted(){window.addEventListener("scroll",this.getScrollTop)},methods:{toTop(e){if(this.scrollState)return;this.scrollState=1,e.preventDefault(),document.documentElement.scrollTop||document.body.scrollTop;let t=this;this.time=setInterval(function(){t.gotoTop(t.scrollTop-t.dParams)},30)},gotoTop(e){this.dParams+=20,e=e>0?e:0,document.documentElement.scrollTop=document.body.scrollTop=window.pageYOffset=e,this.scrollTop<10&&(clearInterval(this.time),this.dParams=20,this.scrollState=0)},getScrollTop(){this.scrollTop=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop}}},bu=e=>(We("data-v-77d80545"),e=e(),Re(),e),vu=bu(()=>_("img",{src:mu},null,-1)),yu=[vu];function _u(e,t,o,n,s,r){return q(),te("div",{class:"scrollTop",onClick:t[0]||(t[0]=(...i)=>r.toTop&&r.toTop(...i))},yu)}const ie=Te(gu,[["render",_u],["__scopeId","data-v-77d80545"]]),wu=e=>(We("data-v-b6c9cecb"),e=e(),Re(),e),Au=wu(()=>_("div",null,"我是WebAPI頁面",-1)),Iu=`
  ...
  `,Tu={__name:"index",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[Au,_("div",null,[_("div",{innerHTML:Iu})]),k(ie)],64))}},Cu=Te(Tu,[["__scopeId","data-v-b6c9cecb"]]),Su=`
...
`,Pu={__name:"TodoListEditDtoAbstract",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[_("div",{innerHTML:Su}),k(ie)],64))}},xu=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
    //===============================================================================================//
...
`,Eu={__name:"AsyncController",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[_("div",{innerHTML:xu}),k(ie)],64))}},Du=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
    //===============================================================================================//
...
`,Lu={__name:"AuthController",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[_("div",{innerHTML:Du}),k(ie)],64))}},ku=e=>(We("data-v-0cf0ef1a"),e=e(),Re(),e),Uu=ku(()=>_("div",null,"這是WebAPI2",-1)),Nu={id:"Vite_to_github",class:"content"},Wu={style:{width:"15%","background-color":"white"}},Ru={style:{width:"80%"}},Mu={key:0},Hu={key:0},Ou={key:0},Fu={__name:"index",setup(e){Ue(!1);let t=Ue(!1),o=Ue(!1);Ue(!1);const n=Ue(!0),s=()=>{n.value=!n.value};return ie.scrollToTop=!0,(r,i)=>(q(),te(J,null,[Uu,_("div",Nu,[_("div",Wu,[re(et(n.value)+" ",1),_("button",{onClick:s,class:so({active:n.value})},">Abstract\\TodoListEditDtoAbstract.cs",2),_("button",{onClick:s,class:so({active:n.value})},"Controller\\AsyncController.cs",2),_("button",{onClick:i[0]||(i[0]=l=>we(o)?o.value=!ge(o):o=!ge(o))},"Controller\\AuthController.cs")]),_("div",Ru,[_("p",null,[k(vt,null,{default:ue(()=>[n.value?(q(),te("div",Mu,[k(Pu)])):Gt("",!0)]),_:1})]),_("p",null,[k(vt,null,{default:ue(()=>[ge(t)?(q(),te("div",Hu,[k(Eu)])):Gt("",!0)]),_:1})]),_("p",null,[k(vt,null,{default:ue(()=>[ge(o)?(q(),te("div",Ou,[k(Lu)])):Gt("",!0)]),_:1})])])]),k(ie)],64))}},Bu=Te(Fu,[["__scopeId","data-v-0cf0ef1a"]]),Vu=_("div",null,"我是RabbitVue3頁面",-1),Gu=`
...
`,Ci={__name:"_4_deployVite",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[_("div",{innerHTML:Ju}),k(ie)],64))}},Qu=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
//===============================================================================================//
...
`,Zu={__name:"_10_vue3_is",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[_("div",{innerHTML:Qu}),k(ie)],64))}},Yu=`
    <div id="Vite_to_github" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
      <pre>
//===============================================================================================//
  import HelloWorld from './components/HelloWorld.vue'
...
`,Xu={__name:"_11_vue3_is",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[_("div",{innerHTML:Yu}),k(ie)],64))}},Qs={__name:"HelloWorld",props:["msg2"],emits:["foo"],setup(e,{emit:t}){const o=t;return setTimeout(()=>{o("foo","onFoo")},2e3),(n,s)=>(q(),te("div",null,[Xo(n.$slots,"default",{},()=>[re("5.HelloWorld.vue")]),re(" "+et(e.msg2)+" ",1),Xo(n.$slots,"default"),Xo(n.$slots,"footer",{msg3:" + msg3 footer props"},()=>[re("footer")])]))}},ze=e=>(We("data-v-2e8c98f2"),e=e(),Re(),e),ed=ze(()=>_("div",null,"這是其他頁",-1)),td=ze(()=>_("div",null,"3.2222",-1)),od=ze(()=>_("div",null,"4.2222",-1)),nd=ze(()=>_("div",null,"5.App傳遞的默認插槽",-1)),sd={id:"Vite_to_github",class:"content"},rd=ze(()=>_("div",null,[re("1.Vue3 CRUD + bootstrap "),_("a",{href:"https://www.youtube.com/watch?v=PrKh6GemOyg",target:"_blank"}," https://www.youtube.com/watch?v=PrKh6GemOyg ")],-1)),id=ze(()=>_("div",null,[re("2.Vue3 學習筆記 "),_("a",{href:"https://hackmd.io/@Lin-Jay/S1xju_nKO",target:"_blank"}," https://hackmd.io/@Lin-Jay/S1xju_nKO ")],-1)),ad=ze(()=>_("div",null,[re("3.Build app using Vue JS, .NET Core Web API and Microsoft SQL Server(create Azure) "),_("a",{href:"https://www.youtube.com/watch?v=TMmhECU3rHs",target:"_blank"}," https://www.youtube.com/watch?v=TMmhECU3rHs ")],-1)),ld=ze(()=>_("a",{href:"https://www.youtube.com/watch?v=yo2bMGnIKE8",target:"_blank"}," https://www.youtube.com/watch?v=yo2bMGnIKE8 ",-1)),cd={key:0},ud=Bn('<div data-v-2e8c98f2>5.先學 axios 基礎與封裝管理 API <a href="https://ithelp.ithome.com.tw/articles/10304656" target="_blank" data-v-2e8c98f2> https://ithelp.ithome.com.tw/articles/10304656 </a></div><div data-v-2e8c98f2>6.[C#][ASP.NET] Web API 開發心得 (7) - 使用 Token 進行 API 授權驗證 <a href="https://ithelp.ithome.com.tw/articles/10199102" target="_blank" data-v-2e8c98f2> https://ithelp.ithome.com.tw/articles/10199102 </a></div><div data-v-2e8c98f2>7.Poy Chang Trial and Error <a href="https://blog.poychang.net/categories/" target="_blank" data-v-2e8c98f2> https://blog.poychang.net/categories/ </a></div><div data-v-2e8c98f2>8.阿里巴巴向量圖標庫: iconfont <a href="https://www.iconfont.cn/" target="_blank" data-v-2e8c98f2> https://www.iconfont.cn/ </a></div><div data-v-2e8c98f2>9.VueUse 中文文檔 <a href="https://vueuse.pages.dev/" target="_blank" data-v-2e8c98f2> https://vueuse.pages.dev/ </a></div><div data-v-2e8c98f2>9.vue3 is我意想不到的用法 <a href="https://segmentfault.com/a/1190000044532342" target="_blank" data-v-2e8c98f2> https://segmentfault.com/a/1190000044532342 </a></div>',6),dd=ze(()=>_("a",{href:"https://blog.csdn.net/kuang_nu/article/details/128834690",target:"_blank"}," https://blog.csdn.net/kuang_nu/article/details/128834690 ",-1)),fd={key:0},pd=ze(()=>_("a",{href:"https://www.bilibili.com/video/BV166421Z7nU/",target:"_blank"}," https://www.bilibili.com/video/BV166421Z7nU/ ",-1)),hd={key:0},md=ze(()=>_("div",null,[re("12.Master xUnit Like A Pro in Under 10 Minutes! "),_("a",{href:"https://www.youtube.com/watch?v=rohq-Wqj0yI",target:"_blank"}," https://www.youtube.com/watch?v=rohq-Wqj0yI ")],-1)),gd={__name:"index",setup(e){let t=Ue(!1),o=Ue(!1),n=Ue(!1);const s=Ue("1.Hello Vue3 + Vite"),r=Oe("div",{style:{color:"red"}},[Oe("span","1.Hello World")],[Oe("p","1.這是一個標籤")]);setTimeout(()=>{s.value="3.111"},2e3);const i=f=>Oe("div",{style:{color:"red"}},f.count),l=(f,{slots:d})=>{var h,g;const p=Ue("4.aaa");return Oe("div",{style:{color:"red"},onClick(){console.log("click")},onMousedown(){console.log("mousedown")}},[(h=d==null?void 0:d.header)==null?void 0:h.call(d,p.value),"4.container",(g=d==null?void 0:d.default)==null?void 0:g.call(d)])},a=(f,{slots:d})=>Oe(Qs,{msg2:"App傳遞的msg2",onFoo(p){console.log("響應的事件foo",p)}},{default:d.default,footer:()=>Oe(Qs,null,{default:()=>Oe("div","5.嵌套的默認插槽"),footer:({msg3:p})=>Oe("div","5.嵌套的footer"+p)})});return ie.scrollToTop=!0,(f,d)=>(q(),te(J,null,[ed,(q(),Ko(La(ge(r)))),k(i,{count:3.1},{default:ue(()=>[td]),_:1}),k(l,{count:4.1},{header:ue(p=>[_("div",null,"4.header "+et(p),1)]),default:ue(()=>[od]),_:1}),k(a,null,{default:ue(()=>[nd]),_:1}),_("div",sd,[rd,id,ad,_("div",null,[re("4.How to Deploy Your Vite App to Github Pages "),ld,_("button",{onClick:d[0]||(d[0]=p=>we(t)?t.value=!ge(t):t=!ge(t))},"Toggle"),k(vt,null,{default:ue(()=>[ge(t)?(q(),te("div",cd,[k(Ci)])):Gt("",!0)]),_:1})]),ud,_("div",null,[re("10.Vue3 動態組件 標籤和:is 的用法 "),dd,_("button",{onClick:d[1]||(d[1]=p=>we(o)?o.value=!ge(o):o=!ge(o))},"Toggle"),k(vt,null,{default:ue(()=>[ge(o)?(q(),te("div",fd,[k(Zu)])):Gt("",!0)]),_:1})]),_("div",null,[re("11.Vue3 h函數的使用 "),pd,_("button",{onClick:d[2]||(d[2]=p=>we(n)?n.value=!ge(n):n=!ge(n))},"Toggle"),k(vt,null,{default:ue(()=>[ge(n)?(q(),te("div",hd,[k(Xu)])):Gt("",!0)]),_:1})]),md]),k(ie)],64))}},bd=Te(gd,[["__scopeId","data-v-2e8c98f2"]]),Si=e=>(We("data-v-c0da6ecf"),e=e(),Re(),e),vd=Si(()=>_("div",null,[_("h2",null,"Dotnet7_vue3"),_("a",{href:"https://www.youtube.com/watch?v=LlYhPO8Ti2U",target:"_blank"}," https://www.youtube.com/watch?v=LlYhPO8Ti2U "),_("div",null,".NET7 Web API | SQL Database | VueJS(3.0) - Composition API | CRUD")],-1)),yd={class:"container"},_d={class:"app-header-nav",style:{"list-style":"none"}},wd=Si(()=>_("div",null,null,-1)),Ad={__name:"index",setup(e){return ie.scrollToTop=!0,(t,o)=>{const n=Do("RouterLink"),s=Do("RouterView");return q(),te(J,null,[vd,_("div",null,[_("div",yd,[_("ul",_d,[_("li",null,[k(n,{to:"/_beach_info"},{default:ue(()=>[re("_Beach_Info.vue")]),_:1})]),_("li",null,[k(n,{to:"/addbeach"},{default:ue(()=>[re("AddBeach.vue")]),_:1})]),_("li",null,[k(n,{to:"/beachList"},{default:ue(()=>[re("BeachList.vue")]),_:1})]),_("li",null,[k(n,{to:"/editbeach"},{default:ue(()=>[re("EditBeach.vue")]),_:1})]),_("li",null,[k(n,{to:"/routerbeach"},{default:ue(()=>[re("router_Beach.vue")]),_:1})]),_("li",null,[k(n,{to:"/confirmDeletePopup"},{default:ue(()=>[re("ConfirmDeletePopup.vue")]),_:1})])])]),k(s),wd]),k(ie)],64)}}},Id=Te(Ad,[["__scopeId","data-v-c0da6ecf"]]),Td=e=>(We("data-v-faca44a6"),e=e(),Re(),e),Cd=Td(()=>_("div",null,"這是_Beach_Info",-1)),Sd=`
...
`,Pd={__name:"_Beach_Info",setup(e){return(t,o)=>(q(),te(J,null,[Cd,_("div",{class:"content"},[_("pre",null,"      "+et(Sd)+`
    `)])],64))}},Zs=Te(Pd,[["__scopeId","data-v-faca44a6"]]),xd=e=>(We("data-v-315d8245"),e=e(),Re(),e),Ed=xd(()=>_("div",null,"這是AddBeach",-1)),Dd=`
  <"script setup
      import axios from 'axios';
      import {reactive} from 'vue';
...
`,Ld={__name:"AddBeach",setup(e){return(t,o)=>(q(),te(J,null,[Ed,_("div",{class:"content"},[_("pre",null,"      "+et(Dd)+`
    `)])],64))}},kd=Te(Ld,[["__scopeId","data-v-315d8245"]]),Ud=e=>(We("data-v-21c2ba9b"),e=e(),Re(),e),Nd=Ud(()=>_("div",null,"這是BeachList",-1)),Wd=`
    <"script setup>
    import { onMounted, ref } from 'vue';
    import axios from 'axios'
...
`,Rd={__name:"BeachList",setup(e){return(t,o)=>(q(),te(J,null,[Nd,_("div",{class:"content"},[_("pre",null,"      "+et(Wd)+`
    `)])],64))}},Md=Te(Rd,[["__scopeId","data-v-21c2ba9b"]]),Hd=e=>(We("data-v-3763e4f1"),e=e(),Re(),e),Od=Hd(()=>_("div",null,"這是EditBeach",-1)),Fd=`
    <"script setup>
        import axios from 'axios';
...
`,Bd={__name:"EditBeach",setup(e){return(t,o)=>(q(),te(J,null,[Od,_("div",{class:"content"},[_("pre",null,"      "+et(Fd)+`
    `)])],64))}},Vd=Te(Bd,[["__scopeId","data-v-3763e4f1"]]),Gd=e=>(We("data-v-f0f2e55e"),e=e(),Re(),e),jd=Gd(()=>_("div",null,"這是_router_Beach",-1)),$d=`
...
`,Kd={__name:"router_Beach",setup(e){return(t,o)=>(q(),te(J,null,[jd,_("div",{class:"content"},[_("pre",null,"      "+et($d)+`
    `)])],64))}},qd=Te(Kd,[["__scopeId","data-v-f0f2e55e"]]),zd=e=>(We("data-v-69fb1a2b"),e=e(),Re(),e),Jd=zd(()=>_("div",null,"這是ConfirmDeletePopup",-1)),Qd=`
<template>
...
`,Zd={__name:"ConfirmDeletePopup",setup(e){return(t,o)=>(q(),te(J,null,[Jd,_("div",{class:"content"},[_("pre",null,`      這放在components\\
      由BeachList 呼叫
      `+et(Qd)+`
    `)])],64))}},Yd=Te(Zd,[["__scopeId","data-v-69fb1a2b"]]),Pi=e=>(We("data-v-d9451320"),e=e(),Re(),e),Xd=Pi(()=>_("div",null,"這是VS Code 功能頁",-1)),ef=Pi(()=>_("div",{id:"Vite_to_github",class:"content"},[_("div",null,[re("1.vS Code文件標簽欄多行顯示 "),_("a",{href:"https://blog.csdn.net/mj475002864/article/details/115456004",target:"_blank"}," https://blog.csdn.net/mj475002864/article/details/115456004 "),_("p",null,"ctrl + shift + p => 查詢 Open Workspace Settings => Wrap Tabs 打勾 ")])],-1)),tf={__name:"index",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[Xd,ef,k(ie)],64))}},of=Te(tf,[["__scopeId","data-v-d9451320"]]),nf=Bn('<div data-v-97fd3d78>這是影音頁</div><div id="Vite_to_github" class="content" data-v-97fd3d78><div data-v-97fd3d78>1.Vue3 CRUD + bootstrap <a href="https://www.youtube.com/watch?v=PrKh6GemOyg" target="_blank" data-v-97fd3d78> https://www.youtube.com/watch?v=PrKh6GemOyg </a></div><div data-v-97fd3d78>2.後台課程管理系統-Vue3版 <a href="https://www.youtube.com/watch?v=yZMTHoGSuVQ&amp;list=PL_vrngOaamYsIovhZ3Cd9M2vPhm3yRTnG" target="_blank" data-v-97fd3d78> https://www.youtube.com/watch?v=yZMTHoGSuVQ&amp;list=PL_vrngOaamYsIovhZ3Cd9M2vPhm3yRTnG </a></div><div data-v-97fd3d78>3.2024年不看后悔的Vue3+.NET7+WebAPI从零手写后台管理系统 <a href="https://www.bilibili.com/video/BV1Km411o7ip?p=1&amp;vd_source=1a5937a80fc962029ba6a7b9ee9a1654" target="_blank" data-v-97fd3d78> https://www.bilibili.com/video/BV1Km411o7ip?p=1&amp;vd_source=1a5937a80fc962029ba6a7b9ee9a1654 </a><a href="https://search.bilibili.com/all?vt=75651059&amp;keyword=2024%E5%B9%B4%E4%B8%8D%E7%9C%8B%E5%90%8E%E6%82%94%E7%9A%84Vue3%2B.NET7%2BWebAPI&amp;from_source=webtop_search&amp;spm_id_from=333.1007&amp;search_source=5" target="_blank" data-v-97fd3d78> https://search.bilibili.com/all?vt=75651059&amp;keyword=2024%E5%B9%B4%E4%B8%8D%E7%9C%8B%E5%90%8E%E6%82%94%E7%9A%84Vue3%2B.NET7%2BWebAPI&amp;from_source=webtop_search&amp;spm_id_from=333.1007&amp;search_source=5 </a></div><div data-v-97fd3d78>4.2023全新C#完全零基础入门教程（附源码） <a href="https://www.bilibili.com/read/cv25507935/" target="_blank" data-v-97fd3d78> https://www.bilibili.com/read/cv25507935/ </a></div></div>',2),sf={__name:"index",setup(e){return Ue(!1),ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[nf,k(ie)],64))}},rf=Te(sf,[["__scopeId","data-v-97fd3d78"]]),af=e=>(We("data-v-578d3ec3"),e=e(),Re(),e),lf=af(()=>_("div",null,"我是DotnetAPI_Angular頁面",-1)),cf=`
    <div id="content" style="display:flex; justify-content: center; background-color: #282923; color:#c1cccc; font-size: 14px;">
    <pre>
  ...
  `,uf={__name:"index",setup(e){return ie.scrollToTop=!0,(t,o)=>(q(),te(J,null,[lf,_("div",null,[_("div",{innerHTML:cf})]),k(ie)],64))}},df=Te(uf,[["__scopeId","data-v-578d3ec3"]]),ff=su({history:Uc("/vue-my-note/"),routes:[{path:"/",component:hu,children:[{path:"",component:Cu},{path:"/kaiWebapi2",component:Bu},{path:"/vue3",component:ju},{path:"/download",component:zu},{path:"/others",component:bd,children:[{path:"/_4_deployVite",component:Ci}]},{path:"/dotnet7_vue3",component:Id,children:[{path:"",component:Zs},{path:"/_beach_info",component:Zs},{path:"/addbeach",component:kd},{path:"/beachList",component:Md},{path:"/editbeach",component:Vd},{path:"/routerbeach",component:qd},{path:"/confirmDeletePopup",component:Yd}]},{path:"/vscode_function",component:of},{path:"/video",component:rf},{path:"/dotnetapi_angular",component:df}]}]}),Kn=Zl(au);Kn.use(oc());Kn.use(ff);Kn.mount("#app");
